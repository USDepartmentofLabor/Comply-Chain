    ...
    return (
        <StaticData>
            <div>
                <h1>
                    <strong>
                        Aspectos b&aacute;sicos de un sistema de cumplimiento
                        social
                    </strong>
                </h1>
                <Accordion pdf={pdf} id="basics-acc">
                    <Accordion.Section id="learning-objectives">
                        ...
                        <Accordion.Panel>
                            <ul>
                                <li>
                                    Comprender los componentes clave de un
                                    sistema de cumplimiento social y c&oacute;mo
                                    encajan.
                                </li>
                                <li>
                                    Familiarizarse de los programas de
                                    cumplimiento social de la industria y de
                                    otras industrias que podr&iacute;an estar a
                                    su disposici&oacute;n.
                                </li>
                                <li>
                                    Comenzar a definir el alcance de su sistema
                                ...
                                <li>
                                    ...
                                    marcar&aacute;n el &eacute;xito de su
                    ...
                    <Accordion.Section id="key-terms">
                        ...
                        <Accordion.Panel>
                            <p>
                                ...
                                : un concepto amplio con el que se procura
                                describir la manera en que las empresas integran
                                las inquietudes sociales y ambientales en sus
                                operaciones, as&iacute; como su
                                interacci&oacute;n con las partes interesadas al
                                margen de los requisitos legales. Tambi&eacute;n
                                se utilizan muchos otros t&eacute;rminos para
                                referirse a estas acciones, como &ldquo;triple
                                cuenta de resultados&rdquo;,
                                &ldquo;sostenibilidad&rdquo;, &ldquo;civismo
                                empresarial&rdquo; y &ldquo;cuestiones
                                ambientales, sociales y de
                                gobernabilidad&rdquo;, entre otros. La
                                &ldquo;rendici&oacute;n de cuentas
                                empresarial&rdquo; es un t&eacute;rmino que
                                suele usarse en referencia a las acciones de las
                                empresas que se vinculan m&aacute;s bien con los
                                requisitos legales.
                            </p>
                            <p>
                                <strong>Sistema de cumplimiento social</strong>:
                                uno de los componentes del programa de RSE,
                                sostenibilidad o rendici&oacute;n de cuentas de
                                una empresa. Un sistema de cumplimiento social
                                es una serie integrada de pol&iacute;ticas y
                                pr&aacute;cticas por las que una empresa procura
                                garantizar la m&aacute;xima adhesi&oacute;n a
                                los elementos de su c&oacute;digo de conducta
                                que abarca cuestiones sociales y laborales.
                            </p>
                            <p>
                                <strong>Cadena de suministro</strong>: una
                                cadena compuesta por todas las organizaciones y
                                los individuos que participan en la
                                producci&oacute;n, el procesamiento, la
                                comercializaci&oacute;n, el transporte o la
                                distribuci&oacute;n de un producto desde el
                                punto de origen hasta la empresa o hasta el
                            ...
                            <div className="small-text">
                                ...
                                <ol>
                                    <li>
                                        Marcha Mundial contra el Trabajo
                                        Infantil.{" "}
                                        <em>
                                            <i>Dirty Cotton:</i>
                                            <i> </i>
                                            <i>
                                                A Research on Child Labour,
                                                Slavery, Trafficking and
                                                Exploitation in Cotton and
                                                Cotton Seed Farming in India.
                                            </i>
                                        </em>{" "}
                                    ...
                                    <li>
                                        ...
                                        .&rdquo; theguardian.com [en
                                        l&iacute;nea] [citado 2015]; disponible
                                    ...
                                    <li>
                                        ...
                                        Unidos. &ldquo;Tayikist&aacute;n.&rdquo;
                                        En el{" "}
                                        <em>
                    ...
                    <Accordion.Section id="topics">
                        ...
                        <Accordion.Panel>
                            <p>
                                Antes de usar esta aplicaci&oacute;n, es
                                importante que se interiorice de los aspectos
                                b&aacute;sicos de un sistema de cumplimiento
                                social. Los enlaces a continuaci&oacute;n pueden
                                ser de utilidad.
                            </p>
                            ...
                            <h3>
                                Incorporaci&oacute;n a un programa de
                                cumplimiento social vigente
                            </h3>
                            <div>
                                <p>
                            ...
                            <div>
                                <p>
                                    ...
                                    veces superior de filiales. La
                                    mayor&iacute;a de las empresas
                                    estadounidenses que realizan transacciones a
                                    nivel mundial trabajan con contratistas,
                                    agentes o productores en el exterior en
                                    lugar de tener sus propias plantas de
                                    producci&oacute;n en el extranjero. Por otra
                                    parte, hay pocas empresas que comercializan
                                    o venden una &uacute;nica l&iacute;nea de
                                    productos y muchas trabajan con centenares,
                                    incluso millares, de productos. Las cadenas
                                    de suministro de las empresas son largas y
                                    complejas, con un gran n&uacute;mero de
                                    eslabones desde los proveedores inmediatos
                                    hasta los establecimientos agropecuarios o
                                    las minas que abastecen la materia prima.
                                </p>
                                <p>
                                    Para la mayor&iacute;a de las empresas,
                                    puede ser dif&iacute;cil lograr un sistema
                                    de cumplimiento social que permita la
                                    fiscalizaci&oacute;n y el control de cada
                                    actor en cada cadena de suministro. Al mismo
                                    tiempo, es fundamental que la empresa no
                                    solo evite provocar o contribuir al trabajo
                                    infantil o al trabajo forzoso por medio de
                                    sus propias actividades, sino que
                                    tambi&eacute;n procure evitar o mitigar una
                                    consecuencia adversa en los derechos
                                    laborales emanada de sus operaciones
                                    comerciales como consecuencia de sus
                                    relaciones comerciales. En el{" "}
                                    <Link to="/steps/2">
                                        segundo paso, Evaluaci&oacute;n de
                                        riesgos e impacto
                                    </Link>
                                    , se describen los procesos de debida
                                    diligencia con los que se debe contar para
                                    identificar estos abusos y el impacto.
                                </p>
                                <p>
                                    De manera ideal, el sistema de cumplimiento
                                    debe estar dise&ntilde;ado para priorizar
                                    esos &aacute;mbitos de las cadenas de
                                    suministro en los que el riesgo de
                                    infracciones laborales atroces es m&aacute;s
                                    alto, ya sea debido al contexto operativo,
                                    los productos o servicios en cuesti&oacute;n
                                    u otras consideraciones pertinentes. Por
                                    necesidad, tal vez deba priorizar
                                    tambi&eacute;n los &aacute;mbitos de las
                                    cadenas de suministro en los que la empresa
                                    ...
                                    , tambi&eacute;n lo ayudar&aacute; a
                                    identificar esos puntos de mayor riesgo e
                                    influencia.
                                </p>
                                <p>
                                ...
                                <OwnWords>
                                    ...
                                    <p>
                                        <em>
                                            &ldquo;Para las empresas que cuenten
                                            con numerosas entidades en sus
                                            cadenas de valor puede resultar
                                            demasiado dif&iacute;cil proceder
                                            con la debida diligencia a fin de
                                            detectar consecuencias adversas en
                                            los derechos humanos en cada
                                            entidad. En tal caso, las empresas
                                            deben identificar las &aacute;reas
                                            generales que presenten el mayor
                                            riesgo de consecuencias adversas en
                                            los derechos humanos, ya sea por el
                                            contexto operativo de determinados
                                            proveedores o clientes, las
                                            operaciones, los productos o los
                                            servicios de que se trate, o por
                                            otras consideraciones pertinentes, y
                                            dar prioridad a la debida diligencia
                                            en materia de derechos humanos en
                                            esas &aacute;reas.&rdquo;
                                        </em>
                                    </p>
                                    <p>
                                        <em>
                                            &ldquo;Los medios a los que recurra
                                            una empresa para asumir su
                                            responsabilidad de respetar los
                                            derechos humanos ser&aacute;n
                                            ...
                                            estructuras de gesti&oacute;n
                                            m&aacute;s informales que las
                                            grandes empresas, de modo que sus
                                            respectivos procesos y
                                            pol&iacute;ticas adoptar&aacute;n
                                            formas diferentes. Sin embargo,
                                            algunas peque&ntilde;as y medianas
                                            empresas pueden provocar graves
                                            consecuencias negativas para los
                                            derechos humanos, que
                                            requerir&aacute;n la adopci&oacute;n
                                            de las correspondientes medidas,
                                            independientemente de su
                                            tama&ntilde;o. La gravedad de esas
                                            consecuencias se determinar&aacute;
                                            en funci&oacute;n de su escala,
                                            alcance y car&aacute;cter
                                            irremediable.&rdquo;
                                        </em>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <em>
                                            ...
                                            complejas en las que una empresa no
                                            haya contribuido a una consecuencia
                                            adversa en los derechos humanos,
                                            pero esa consecuencia tenga, no
                                            obstante, una conexi&oacute;n
                                            directa con sus operaciones,
                                            productos o servicios por la
                                            relaci&oacute;n comercial que tiene
                                            con otra entidad, &hellip; la
                                            empresa, sola o en
                                            cooperaci&oacute;n con otras
                                            entidades, conforme sea pertinente,
                                            [debe] usar su influencia para
                                            incidir en la entidad que provoca la
                                            consecuencia adversa en los derechos
                                            humanos con el fin de prevenir o
                                            mitigar esa consecuencia. &lsquo;Las
                                            relaciones comerciales&rsquo;
                                            comprenden las relaciones con socios
                                            comerciales, entidades en la cadena
                                            de suministro y cualquier otra
                                            entidad estatal o no estatal que
                                            est&eacute; vinculada directamente
                                            con las operaciones, los productos o
                                            servicios de la empresa.&rdquo;
                                        </em>
                                    </p>
                                    <p>
                                        Fuente:{" "}
                                    ...
                                    <p>
                                        <em>
                                            &ldquo;La Corporaci&oacute;n
                                            Financiera Internacional (CFI)
                                            establece que las empresas que se
                                            beneficien con empr&eacute;stitos de
                                            la CFI deben acatar ocho normas de
                                            desempe&ntilde;o en cuestiones
                                            ambientales y sociales. La norma de
                                            desempe&ntilde;o 2 establece las
                                            responsabilidades de las empresas en
                                            relaci&oacute;n con cuestiones de
                                            mano de obra y empleo. Con respecto
                                            a sus propios empleados, las
                                            empresas son responsables de
                                            identificar y remediar problemas en
                                            sus normas fundamentales del
                                            trabajo. Con respecto a los
                                            trabajadores contratados, la
                                            responsabilidad de la empresa es
                                            m&aacute;s limitada, y con respecto
                                            a los trabajadores en sus cadenas de
                                            ...
                                            problemas de seguridad de magnitud.
                                            La CFI define a los
                                            &ldquo;trabajadores en la cadena de
                                            suministro&rdquo; como &ldquo;los
                                            trabajadores contratados por los
                                            proveedores principales [de la
                                            empresa] &hellip;los proveedores
                                            principales son aquellos que, de
                                            manera continua, suministran bienes
                                            o materiales esenciales para los
                                            &hellip;procesos de negocios
                                            centrales de la
                                            empresa&hellip;&rdquo;
                                        </em>
                                    </p>
                                    <p>
                                        Fuente:{" "}
                            ...
                            <p>
                                ...
                                compuesto por un equipo de gesti&oacute;n,
                                ubicado en la casa matriz, y un equipo en el
                                terreno, ubicado en los pa&iacute;ses
                                abastecedores de productos, mientras que las
                                PyME suelen tener equipos de cumplimiento social
                                m&aacute;s peque&ntilde;os.
                            </p>
                            <p>
                                Las estructuras empresariales var&iacute;an
                                ampliamente pero el equipo de cumplimiento
                                social suele ser parte del departamento de
                                Responsabilidad Social Empresarial (RSE) o de
                                Sostenibilidad de la empresa. La nota distintiva
                                de los equipos m&aacute;s exitosos de
                                cumplimiento social o RSE es la l&iacute;nea
                                directa de comunicaci&oacute;n que poseen con
                                las instancias decisorias de mayor nivel,
                                incluidos el ejecutivo principal y el
                                Directorio. Adem&aacute;s, la funci&oacute;n de
                                cumplimiento social o RSE debe estar bien
                                integrada con otros componentes de la empresa,
                                en particular en &aacute;mbitos como la
                                gesti&oacute;n de la cadena de suministro, la
                                creaci&oacute;n de productos y el
                                abastecimiento. Por ejemplo, la funci&oacute;n
                                de cumplimiento social de Nike Corporation se
                                encuentra dentro de su &ldquo;
                                <a
                                    target="_blank"
                                    rel="noopener noreferrer"
                                ...
                                &rdquo;, al cual le compete no solo el
                                cumplimiento ambiental y social sino
                                tambi&eacute;n la creaci&oacute;n de productos.
                            </p>
                            <p>
                                El equipo de gesti&oacute;n del cumplimiento
                                social fiscaliza todo el sistema de cumplimiento
                                social. Planea actividades, vigila la
                                aplicaci&oacute;n, le da seguimiento y recibe y
                                analiza los informes del terreno. Lo ideal
                                ser&iacute;a que el equipo cuente con la
                                facultad de tomar decisiones sobre situaciones
                                individuales y sobre el sistema en su totalidad.
                                M&aacute;s all&aacute; de las aptitudes de
                                gesti&oacute;n centrales, como la
                                elaboraci&oacute;n del presupuesto y el
                                an&aacute;lisis de datos, el equipo de
                                gesti&oacute;n debe incluir a integrantes que
                                posean la flexibilidad de abordar situaciones
                                inesperadas, que puedan motivar y apoyar al
                                equipo en el terreno as&iacute; como promover la
                                causa en nombre del sistema ante la gerencia
                                superior. Los miembros del equipo de
                                gesti&oacute;n siempre deben estar expuestos de
                                alguna manera al terreno. Deben seguir de cerca
                                las auditor&iacute;as, hablar con los
                                trabajadores y los sindicatos que los
                                representan, tanto en el lugar de trabajo como
                                fuera, y vivir en carne propia la realidad de
                                los lugares de trabajo que abastecen los
                                productos.&nbsp;
                            </p>
                            <p>
                                Adem&aacute;s, el equipo de gesti&oacute;n del
                                cumplimiento social debe tener continuidad a
                                largo plazo. En las empresas en que el
                                cumplimiento social est&aacute; separado de
                                otras funciones empresariales, la partida de uno
                                o dos integrantes clave del equipo puede
                                repercutir adversamente en todo el programa de
                                cumplimiento social. En consecuencia, es
                                importante que el equipo fortalezca la capacidad
                                de todo el personal de manera que las
                                operaciones puedan sobrevivir a los cambios de
                                personal.
                            </p>
                            <p>
                                Finalmente, el equipo de gesti&oacute;n debe
                                contar con los recursos adecuados para hacer su
                                trabajo. Por sobre todo, cuando la alta gerencia
                                asigna recursos y hay estructuras de incentivos
                                por desempe&ntilde;o que recompensan a los
                                empleados por la innovaci&oacute;n, la
                                iniciativa y el impacto del cumplimiento social,
                                se env&iacute;a el mensaje de que a la empresa
                                le importa el cumplimiento social.
                            </p>
                            <p>
                                Los equipos de cumplimiento en el terreno
                                est&aacute;n conformados por auditores sociales
                                que realizan auditor&iacute;as sociales en las
                                plantas de producci&oacute;n y que trabajan con
                                la gerencia de la f&aacute;brica para
                                identificar estrategias de remediaci&oacute;n
                                procedentes. La composici&oacute;n de los
                                equipos en el terreno, las aptitudes necesarias
                                y las cuestiones conexas se analizan en el{" "}
                                <Link to="/steps/5">
                        ...
                        <Accordion.Panel>
                            <ol>
                                ...
                                <li>
                                    ...
                                    19011. Estas normas abordan cuestiones como
                                    la imparcialidad y la confidencialidad, el
                                    control de documentaci&oacute;n y registros,
                                    los ex&aacute;menes que realiza la gerencia,
                                    criterios de calificaci&oacute;n del
                                    personal, procedimientos de
                                    auditor&iacute;a, apelaciones y demandas;
                                ...
                                <li>
                                    ...
                                    se abordan los elementos de los Sistemas de
                                    Gesti&oacute;n Ambiental y Social (SGAS)
                                    efectivos; disponible en idioma
                                    ingl&eacute;s solamente en{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <li>
                                    ...
                                    ofrece el programa &ldquo;Huella
                                    social&rdquo; que se centra en la
                                    formulaci&oacute;n de sistemas de
                                    ...
                                    en la web para reforzar las competencias;
                                    disponible en{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <li>
                                    ...
                                    <em>
                                        ...
                                        los Derechos Humanos: Puesta en
                                        pr&aacute;ctica del marco de las
                                        Naciones Unidas para &quot;proteger,
                                        respetar y remediar.&quot;
                                    </em>{" "}
                                    Nueva York: 21 de marzo de 2011; disponible
                                    en{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
