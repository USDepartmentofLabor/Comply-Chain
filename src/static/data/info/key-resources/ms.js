                ...
                <EiaList id="eia-list">
                    ...
                    <li>
                        <Link to="/basics#eicc">
                            ...
                            Code of Conduct &ndash; Management Systems
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    <BorderSeparator />
                    <li>
                        ...
                        >
                            Engagement with Government: Brazil&rsquo;s
                            &ldquo;Dirty List&rdquo; and Institute of the
                    ...
                    <li>
                        <Link to="/steps/1/topic/4#sug_phil" id="sug_phil">
                            Multi-stakeholder Efforts to Eliminate Child Labor
                            in the Sugarcane Sector in the Philippines
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    <BorderSeparator />
                    ...
                    <li>
                        <Link to="/steps/1/topic/5#gbn" id="gbn">
                            ILO&rsquo;s Global Business Network on Forced Labor
                    ...
                    <li>
                        <Link to="/steps/2/topic/6#leber" id="leber">
                            Leber Jeweler: The Jewelers&rsquo; Burma Relief
                            Project
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    ...
                    <li>
                        <Link to="/steps/2/topic/6#lco" id="lco">
                            League Collegiate Outfitters: Creating Opportunities
                            for Disadvantaged Youth in El Salvador
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    ...
                    <li>
                        <Link to="/steps/4/topic/4#cocoa" id="cocoa">
                            The International Chocolate and Cocoa Industry
                            &ndash; World Cocoa Foundation&rsquo;s CocoaAction
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    <BorderSeparator />
                    ...
                    <li>
                        <Link to="/steps/5/topic/3#rst1a" id="rst1a">
                            Responsible Sourcing Tool 1A, Sample Benchmarks of
                            Good Practice in Recruitment and Employment
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    <BorderSeparator />
                    ...
                    <li>
                        <Link to="/steps/6/topic/1#turkey" id="turkey">
                            Collaboration to Address Seasonal Migrant Child
                            Labor in Turkey&rsquo;s Hazelnut Harvest
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    <BorderSeparator />
                    ...
                    <li>
                        <Link to="/steps/7/topic/1#fla" id="fla">
                            The Fair Labor Association&rsquo;s (FLA)
                            Accreditation Program for Independent External
                            Monitors
                            <Icons.ChevronRight />
                        </Link>
                    </li>
