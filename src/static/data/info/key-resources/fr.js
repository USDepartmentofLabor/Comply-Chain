    ...
    return (
        <StaticData>
            <div>
                ...
                <BorderSeparator />
                <p>
                    Organisation de coop&eacute;ration et de
                ...
                <p>
                    <em>
                        ...
                        Preventing Forced Labour [en anglais]
                    </em>
                </p>
                <p>
                    <a
                ...
                <EiaList>
                    ...
                    <li>
                        <Link to="/steps/1/topic/4#sug_phil" id="sug_phil">
                            Efforts tripartites pour abolir le travail des
                            enfants dans les champs de canne &agrave; sucre aux
                            Philippines
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    ...
                    <li>
                        <Link to="/steps/1/topic/5#gbn" id="gbn">
                            R&eacute;seau mondial d&apos;entreprises de
                            l&rsquo;OIT sur le travail forc&eacute; et la traite
                    ...
                    <li>
                        <Link to="/steps/3/topic/4#patagonia" id="patagonia">
                            Normes relatives aux travailleurs migrants de
                            Patagonia
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    ...
                    <li>
                        <Link to="/steps/3/topic/5#fair_labor" id="fair_labor">
                            Processus de r&eacute;vision du code de la Fair
                            Labor Association
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    ...
                    <li>
                        <Link to="/steps/6/topic/1#turkey" id="turkey">
                            ...
                            travail saisonnier des enfants migrants dans le
                            cadre de la r&eacute;colte des noisettes en Turquie
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    <BorderSeparator />
                    ...
                    <li>
                        <Link to="/steps/7/topic/1#fla" id="fla">
                            ...
                            ind&eacute;pendants par la Fair Labor Association
                            (FLA)
                            <Icons.ChevronRight />
                        </Link>
                    </li>
                    ...
                    <li>
                        <Link to="/steps/7/topic/1#bonsucro" id="bonsucro">
                            Mod&egrave;le d&apos;accr&eacute;ditation de
                            Bonsucro
                            <Icons.ChevronRight />
                        </Link>
                    </li>
