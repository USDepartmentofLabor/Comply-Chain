                            ...
                            <ol>
                                <li>
                                    ...
                                    <em>
                                        ...
                                        <i> </i>
                                        <i>
                                            Social Audits, Workplace
                                            Certification and Twenty Years of
                                            Failure to Protect Worker Rights
                                        </i>
                                        ;
                                    </em>{" "}
                                    1° de agosto de 2014; disponible en idioma
                                ...
                                <li>
                                    ...
                                    <em>
                                        <i>
                                            Danone and IUF Sign Tenth Agreement
                                            on Sustainable Employment
                                        </i>
                                    </em>
                                    . [en la web, consultado el 16 de mayo de
                                ...
                                <li>
                                    ...
                                    , 2016 [en la web, consultado el 16 de mayo
                                    de 2016]. Disponible en idioma ingl&eacute;s
                                    solamente en{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <li>
                                    ...
                                    Ginebra, 2008; disponible en idioma
                                    ingl&eacute;s solamente en{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <li>
                                    ...
                                    ; Ginebra, 2010; disponible en idioma
                                    ingl&eacute;s solamente en{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <li>
                                    OIT-OIE.{" "}
                                    <i>
                                        International framework agreements: an
                                        employers&rsquo; guide;
                                    </i>{" "}
                                    2007; disponible en idioma ingl&eacute;s
                                    solamente en{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
