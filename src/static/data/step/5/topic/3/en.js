    ...
    return (
        <StaticData>
            <div>
                ...
                <p>
                    Every company&rsquo;s code and audit tools should include the following standards set forth in ILO Conventions:
                </p>
                <h2>Child Labor</h2>
                <ul>
                    <li>
                        The minimum age for work should be 15 years old, or 14 years old if countries have ratified Convention 138 and 
                        submitted a justification for a lower minimum age to the ILO upon ratification.
                    </li>
                    <li>
                        It is permissible for children and young persons below the minimum age for work to perform work <em>in schools</em> for 
                        general, vocational, or technical education.
                    </li>
                    <li>
                        It is also permissible for children ages 14 and above to perform work outside of school that is part of a vocational or 
                        occupational training program with certain safeguards.
                    </li>
                    <li>
                        Children ages 13&ndash;15 (or 12&ndash;14 in countries with a minimum age of 14) are permitted to perform &ldquo;light 
                        work&rdquo; that is not harmful to their health or development and does not interfere with school so long as the country 
                        sets forth the specified work activities children can perform, the number of hours, and the conditions of work.
                    </li>
                </ul>
                <p>
                    The following consist of the Worst Forms of Child Labor and should be prohibited to all children under age 18:
                </p>
                <ol type="1">
                    <li>
                        ...
                        and forced or compulsory labor, including forced or compulsory recruitment of children for use in armed conflict.
                    </li>
                    <li>
                ...
                <p>
                    The hazardous work referred to in ILO Convention 182 Article 3(d) &ldquo;shall be determined by national laws or regulations 
                    or by the competent authority, after consultation with the organizations of employers and workers concerned, taking into 
                    consideration relevant international standards&#8230;&rdquo; (ILO Convention 182, Article 4). As this suggests, forms of work 
                    identified as &ldquo;hazardous&rdquo; for children (Article 3[d]) may vary from country to country. Countries develop their own 
                    lists of hazardous work prohibited to all children under age 18. ILO Recommendation No. 190, which accompanies ILO Convention 182, 
                    gives additional guidance on identifying &ldquo;hazardous work.&rdquo; ILO Recommendation No. 190 states in Section II, Paragraph 3 
                    that &ldquo;[i]n determining the types of work referred to under Article 3(d) of the Convention [ILO Convention 182], and in 
                ...
                <ol type="a">
                    ...
                    <li>
                        work in an unhealthy environment which may, for example, expose children to hazardous substances, agents or processes, 
                        or to temperatures, noise levels, or vibrations damaging to their health;
                    </li>
                    <li>
                        work under particularly difficult conditions such as work for long hours or during the night or work where the child is 
                        unreasonably confined to the premises of the employer.&rdquo;
                    </li>
                </ol>
                <h2>Forced Labor / Trafficking in Persons</h2>
                <p>
                    All codes of conduct should include provisions prohibiting forced labor and trafficking in persons. Forced labor and trafficking 
                    are closely related and, in some instances, overlapping phenomena, and these issues are often combined into a single category in 
                    a code of conduct.
                </p>
                <p>
                    In{" "}
                ...
                <p>
                    In recent years, as companies have learned more about the nature of forced labor and the forms it takes in supply chains, they 
                    have begun integrating new provisions into codes of conduct. Examples include prohibitions on worker payment of recruitment fees 
                    and requirements for suppliers to hire workers using &ldquo;direct hiring&rdquo; or &ldquo;direct employment&rdquo; practices. A{" "}
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://www8.hp.com/h20195/v2/getpdf.aspx/c05116077.pdf"
                ...
                <ExampleInAction id="rst1">
                    ...
                    <p>
                        ...
                        . The content of RST was provided by Verit&eacute;, a labor rights organization with expertise in supply chain compliance, with funds 
                        from the U.S. Department of State&rsquo;s Office to Monitor and Combat Trafficking in Persons under Cooperative Agreement 
                        S-SJTIP-13-CA-1029. The development of RST was informed by experts from several U.S. government agencies, including the U.S. Departments 
                        of State and Labor, and other primary stakeholders, including trafficking survivors, corporate and NGO leaders, and acquisitions 
                    ...
                    <h2>
                        ...
                        <strong>
                            ...
                            <p>
                                ...
                                <ol>
                                <li>
                                    There must be no forced or compulsory labor in any form, including bonded, indentured, trafficked, or prison labor, and 
                            ...
                            <p>
                                ...
                                <li>
                                    In any given country, the minimum working age, as well as rules regarding the employment of a Young Worker, will be 
                                    defined by the conventions of the ILO or national/regional law, whichever affords greater protection to the individual. 
                                    For clarity, Young Worker in this context refers to an individual above the legal working age but before their 18th birthday.
