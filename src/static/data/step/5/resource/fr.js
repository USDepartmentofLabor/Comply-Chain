            ...
            <ol>
                <li>
                    ...
                    <em>
                        ...
                        recherche sur les enfants astreints aux pires formes de
                ...
                <li>
                    OIT-IPEC.{" "}
                    <em>
                        Principes directeurs pour l&apos;&eacute;laboration de
                        processus d&apos;observation et de suivi du travail des
                        enfants (OSTE).
                    </em>{" "}
                    2005; disponible sur{" "}
                    <a target="_blank" rel="noopener noreferrer"
                ...
                <li>
                    Verit&eacute;.{" "}
                    <em>
                        Responsible Sourcing Tool: Recruitment and Employment
                        Benchmarks&nbsp;;{" "}
                    </em>
                    disponible [en anglais] sur{" "}
                    <a target="_blank" rel="noopener noreferrer"
