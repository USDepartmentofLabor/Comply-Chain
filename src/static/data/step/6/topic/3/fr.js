        ...
        <StaticData>
            <div>
                ...
                <ul>
                    ...
                    <li>
                        Une vue d&apos;ensemble exhaustive de votre
                ...
                <p>
                    ...
                    &eacute;quipe pourrait inclure l&apos;utilisation d&apos;un
                ...
                <p>
                    ...
                    et comment se servir de ces donn&eacute;es dans la prise de
                    d&eacute;cisions sur le d&eacute;veloppement de produits et
                    l&apos;approvisionnement, ainsi que des informations
                    courantes concernant les r&eacute;sultats de
                    conformit&eacute; sociale des fournisseurs. Il est essentiel
                    de discuter avec les concepteurs de produits et les
                    acheteurs d&rsquo;une entreprise des incidences qu&apos;ont
                    leurs pratiques et leurs d&eacute;cisions sur la
                    conformit&eacute; sociale. Dans l&apos;id&eacute;al, les
                    &eacute;valuations de performance et les structures
                    d&apos;incitation de ces &eacute;quipes devraient tenir
                    compte de la mesure dans laquelle elles se servent des
                    donn&eacute;es relatives &agrave; la conformit&eacute;
                    sociale. L&apos;implication et la participation des plus
                ...
                <p>
                    ...
                    employ&eacute;s sont conscients de l&apos;engagement pris
                    par l&apos;entreprise en faveur de la conformit&eacute;
                    sociale. Un syst&egrave;me de prix ou d&apos;incitations qui
                    r&eacute;compense les employ&eacute;s les plus performants
                    dans le domaine de la conformit&eacute; sociale est une
                ...
                <p>
                    ...
                    fournisseur/agent devrait &ecirc;tre tenu de signer un
                    engagement de conformit&eacute; avec le code de conduite,
                    engagement qui sera inclus dans le contrat. Le contrat
                    devrait &eacute;galement pr&eacute;ciser toutes les
                    activit&eacute;s que le fournisseur/agent devra entreprendre
                    dans le cadre du syst&egrave;me, par exemple garantir aux
                    auditeurs et aux organisations de v&eacute;rification un
                    acc&egrave;s libre aux &eacute;tablissements de production.
                    Si une entreprise entretient des relations relativement
                    stables avec les fournisseurs/agents, vous pourriez adopter
                    un mod&egrave;le de conformit&eacute; sociale o&ugrave; une
                    grande partie de la responsabilit&eacute; de la
                ...
                <p>
                    ...
                    directement avec les fournisseurs. Le fournisseur devrait
                    &ecirc;tre tenu de signer un engagement de conformit&eacute;
                    avec le code de conduite, engagement qui sera inclus dans le
                    contrat. Le contrat devrait &eacute;galement pr&eacute;ciser
                    toutes les activit&eacute;s que le fournisseur devra
                    entreprendre dans le cadre du syst&egrave;me, par exemple
                    garantir aux auditeurs et aux organisations de
                    v&eacute;rification un acc&egrave;s libre aux
                ...
                <ul>
                    ...
                    <li>
                        ...
                        sous-traitants et aux niveaux sp&eacute;cifi&eacute;s de
                ...
                <ul>
                    ...
                    <li>
                        ...
                        travailleurs disposent d&apos;un contrat
                        pr&eacute;cisant clairement les modalit&eacute;s de leur
                        emploi, &eacute;crit d&rsquo;une fa&ccedil;on
                    ...
                    <li>
                        ...
                        r&eacute;clament pas des commissions, qu&apos;ils ne
                ...
                <p>
                    Dans toute la mesure du possible, vos programmes de
                    formation et de renforcement des capacit&eacute;s devraient
                    inclure les fournisseurs au-del&agrave; du premier niveau.
                    Lorsque votre &eacute;valuation des risques a
                    identifi&eacute; les domaines de vos cha&icirc;nes
                    d&apos;approvisionnement courant le plus grand risque de
                    travail des enfants, de travail forc&eacute; ou
                    d&apos;autres abus des droits du travail, vous aurez alors
                    une id&eacute;e des fournisseurs, &agrave; tous les
                    &eacute;chelons, ayant le plus besoin de formation. Les
                    documents de formation &eacute;labor&eacute;s par vos soins
                    pour les fournisseurs de premier niveau peuvent &ecirc;tre
                    adapt&eacute;s pour les autres niveaux de la cha&icirc;ne
                    d&apos;approvisionnement. Comme indiqu&eacute;, vous pouvez
                    &eacute;galement exiger que les fournisseurs/agents ou les
                    fournisseurs/producteurs offrent cette formation. Signalons
                    que certaines entreprises r&eacute;alisent des gains
                    d&rsquo;efficacit&eacute; en r&eacute;unissant plusieurs
                    fournisseurs, par exemple tous les fournisseurs
                    op&eacute;rant dans un m&ecirc;me pays ou dans une
                ...
                <ul>
                    ...
                    <li>
                        ...
                        des non-migrants, et qu&apos;ils ont libre acc&egrave;s
                        &agrave; leurs pi&egrave;ces d&apos;identit&eacute; et
                        un lieu s&ucirc;r pour les y conserver.
                    </li>
                </ul>
                <p>
                    Il est important de noter que dans certaines industries,
                    particuli&egrave;rement l&apos;agriculture, certains
                    travailleurs sont analphab&egrave;tes. Le code de conduite
                    de Starbucks*, appel&eacute;{" "}
                    <a
                        target="_blank"
                    ...
                    analphab&egrave;tes soient inform&eacute;s oralement de
                    leurs droits en vertu du code.
                </p>
            </div>
        </StaticData>
    );
