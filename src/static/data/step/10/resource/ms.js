...
const ms = () => {
    return (
        <StaticData>
            ...
            <ol>
                    <li>
                        Persatuan Buruh Adil (Fair Labor Association) Laporan Pemantauan Tempat Kerja. talian, diakses Ogos 4, 2020]; boleh didapati dari {" "}
                        <a
                            target="_blank"
                    ...
                    <li>
                        Google. Laporan Ketelusan Google. [talian, akses Ogos 4, 2020]; boleh didapati dari  {" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <li>
                        Inisiatif Laporan Global, Kompak Global PBB dan Merealisasikan Hak.{" "}
                        <em>
                            Laporan Korporat Hak Asasi Manusia
                        </em>
                        Analisis Trend Semasa; Inisiatif Globalisasi Beretika, November 2009; boleh didapati dari {" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <li>
                        GSK. Hak asasi manusia dan perhambaan moden [talian, diakses Ogos 4, 2020]; boleh didapati dari {" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <li>
                        HP. Impak Lestari [talian, diakses Ogos 4, 2020]; boleh didapati dari {" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <li>
                        Shift dan Mazars. <em>Laporan Pangkalan Data UNGP</em>.
                        [talian, akses Mei 16, 2016]; boleh didapati dari {" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <li>
                        Dana Kanak-Kanak PBB, Hak kanak-kanak dalam laporan lestari: Panduan untuk menggabungkan hak kanak-kanak ke dalam 
                        laporan berdasar GRI, Geneva; 2014; boleh didapati dari {" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <li>
                        Kompak Global PBB dan Inisiatif Laporan Global Stichting (GRI), Menjalin Kaitan: Menggunakan Panduan GRI G4 untuk 
                        Memberitahu Kemajuan mengenai Prinsip Kompak Global PBB, 2013; boleh didapati dari{" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
