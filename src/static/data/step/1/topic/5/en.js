...
const en = () => {
    return (
        <div>
            ...
            <p>
                Another way to identify and engage stakeholders and partners is
            ...
            <ExampleInAction id="sug_phil">
                ...
                <p>
                    ...
                    labor in tobacco production and in protecting and improving
                    the lives of children in tobacco growing areas. The ECLT
                    Foundation&rsquo;s efforts follow a tripartite model that
                    includes governments, trade unions, and employers, as well
                    as civil society organizations, public sector
                    ...
                    , the ECLT Foundation engages in global advocacy on child
                    labor, as well as serves as a hub for research and improving
                    the knowledge base on child labor. Since 2003, the ECLT
                    ...
                    . These projects have five strategic objectives: withdrawing
            ...
            <ExampleInAction id="clt">
                ...
                <p>
                    ...
                    obstacles to the implementation of the ILO Conventions on
                    child labor in supply chains and surrounding communities,
                    identify practical ways of overcoming these obstacles, and
                    catalyse collective action. This means carrying out due
                    diligence to identify, prevent, mitigate, remediate, and
                    account for any adverse effects on children&rsquo;s right to
                    be free from child labour that businesses cause, contribute
                    to, or are linked with through their relationships and
            ...
            <ExampleInAction id="gbn">
                ...
                <p>
                    The ILO&rsquo;s Global Business Network on Forced Labor and
                    Human Trafficking, supported by initial funding from DOL and
                    Mars, Inc.*, is set to launch in 2018 and will bring
                    together employers&rsquo; organizations, businesses, and
                    other stakeholders to provide opportunities to share
                    information on how companies from a range of sectors conduct
                    due diligence and risk assessments related to forced labor
                    and human trafficking in their business operations. The
                    Global Business Network will provide opportunities for
                    companies to benchmark their performance and to facilitate
                    peer learning on forced labor issues, including through the
                    exchange of information on self-regulatory initiatives and
                    best practices on managing complex supply chains. The Global
                    Business Network will work in close collaboration with the
