...
const es = () => {
    return (
        <div>
            <h1>Asociaciones e iniciativas de la industria</h1>
            <p>
                Otra manera de identificar e incluir a las partes interesadas y
                los socios es a trav&eacute;s de las asociaciones de la
            ...
            <div class="example-in-action" id="sug_phil">
                ...
                <p>
                    ...
                    >
                        Fundaci&oacute;n ECLT
                    </a>{" "}
                    emplea un enfoque que comprende a varias partes interesadas
                    en prevenir el trabajo infantil en la producci&oacute;n de
                    tabaco, as&iacute; como en proteger y mejorar la vida de los
                    ni&ntilde;os que se encuentran en las zonas de cultivo de
                    tabaco. Las iniciativas de la Fundaci&oacute;n ECLT
                    responden a un modelo tripartito que abarca a gobiernos,
                    sindicatos y empleadores, as&iacute; como a organizaciones
                    ...
                    >
                        Plataforma sobre el trabajo infantil de la OIT
                    </a>
                    , la Fundaci&oacute;n ECLT se dedica a abogar a favor de
                    combatir el trabajo infantil a nivel mundial y funge de
                    centro de investigaci&oacute;n y mejora de la base de
                    conocimientos sobre el trabajo infantil. Desde 2003, la
                    Fundaci&oacute;n ECLT ha realizado proyectos con una gama de
                    ...
                    . Estos proyectos tienen cinco objetivos
                    estrat&eacute;gicos: retirar a los ni&ntilde;os del trabajo
                    ...
                    >
                        alianza p&uacute;blico-privada de 3 a&ntilde;os con la
                        OIT
                    </a>{" "}
            ...
            <div class="example-in-action" id="clt">
                ...
                <p>
                    ...
                    es un foro dirigido por empresas que aspira a combatir el
                    trabajo infantil en las cadenas de suministro. Mediante la
                    Plataforma se identifican los obst&aacute;culos para la
                    aplicaci&oacute;n de los Convenios de la OIT en materia de
                    trabajo infantil en las cadenas de suministro y en las
                    comunidades aleda&ntilde;as, se identifican maneras
                    pr&aacute;cticas de sobreponerse a dichos obst&aacute;culos
                    y se catalizan las acciones colectivas. Esto significa
                    realizar la debida diligencia a fin de identificar,
                    prevenir, mitigar, remediar y dar cuenta de los efectos
                    adversos al derecho de los ni&ntilde;os de estar exentos de
                    realizar el trabajo infantil causado o fomentado por las
                    empresas o vinculado a ellas por sus relaciones y
                    ...
                    >
                        Confederaci&oacute;n Sindical Internacional (CSI)
                    </a>{" "}
                    como copresidentes. En 2015, los miembros de la Plataforma,
                    ...
                    >
                        Herramienta de orientaci&oacute;n sobre el trabajo
                        infantil destinada a las empresas
                    </a>
                    ...
                    en materia de trabajo infantil. La Plataforma constantemente
            ...
            <div class="example-in-action" id="gbn">
                ...
                <p>
                    En 2018 se lanzar&aacute; la Red mundial de empresas sobre
                    trabajo forzoso y trata de seres humanos de la OIT,
                    financiada inicialmente por el Departamento de Trabajo y
                    Mars, Inc.*, que agrupar&aacute; a organizaciones
                    patronales, empresas y dem&aacute;s interesados para que
                    compartan informaci&oacute;n sobre c&oacute;mo las empresas
                    de una gama de sectores realizan la debida diligencia y las
                    evaluaciones de riesgo relativas al trabajo forzoso y la
                    trata de seres humanos en sus operaciones comerciales. La
                    Red permitir&aacute; que las empresas comparen su
                    desempe&ntilde;o y facilitar&aacute; el aprendizaje entre
                    hom&oacute;logos de cuestiones de trabajo forzoso, entre
                    otros, mediante el intercambio de informaci&oacute;n sobre
                    iniciativas autorreguladas y las mejores pr&aacute;cticas en
                    el manejo de cadenas de suministro complejas. Adem&aacute;s,
                    la Red trabajar&aacute; en estrecha colaboraci&oacute;n con
                    ...
                    <a href="http://www.alliance87.org/" title="Alianza 8.7">
                        Alianza 8.7
                    </a>{" "}
