...
const en = () => {
    return (
        <StaticData>
            <div>
                <h1>Undang-Undang dan Peraturan</h1>
                <p>
                    Sistem pematuhan sosial yang secara tradisional dipandang sebagai usaha murni
                    sukarela, semakin menjadi alat yang penting untuk memenuhi syarat undang-undang.
                    Perundangan di AS, terutama{" "}
                    <a
                    ...
                    banyak undang-undang yang diluluskan dan peraturan di isytiharkan di dalam dan di luar AS yang memperkuatkan
                    perlindungan ke atas buruh kanak-kanak dan buruh paksa dalam rantai bekalan. Tambahan pula, ada beberapa negara
                    yang menggabungkan beberapa peruntukan buruh ke dalam perjanjian perdagangan mereka. Satu contoh baru-baru ini
                    ialah perjanjian Amerika Syarikat-Mexico-Kanada (USMCA) yang mempunyai standard buruh yang dikuatkuasakan
                    sepenuhnya - termasuk penguatkuasaan undang-undang mengenai buruh paksa dan buruh kanak-kanak. USMCA juga
                    memasukkan peruntukan baru yang menghendaki pihak yang berkenaan mengambil langkah-langkah untuk melarang
                    pengimportan barang-barang yang dihasilkan oleh buruh paksa termasuk buruh kanak-kanak yang dipaksa, untuk
                    menangani kekerasan terhadap pekerja yang menjalankan hak mereka, untuk mengatasi diskriminasi berdasarkan
                    jantina di tempat kerja dan untuk memastikan pekerja migran dilindungi di bawah undang-undang buruh.
                </p>
                <p>
                    Undang-undang dan peraturan mengenai ketekunan wajar merangkumi pendekatan yang pelbagai dan berubah-ubah.
                    Pusat Perniagaan dan Sumber Hak Asasi Manusia menyimpan senarai&nbsp;
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <ul id="law-list">
                    ...
                    <Accordion id="why-develop-acc">
                        <Accordion.Section id="law-order">
                            <Accordion.Title>
                                <strong>
                                    Perintah Eksekutif 13126, Melarang Pemerolehan Produk
                                    yang dikeluarkan oleh Buruh Paksa atau Buruh Kontrak Kanak-Kanak ,
                                    dan peraturan yang dilaksanakan
                                </strong>
                            </Accordion.Title>
                            <Accordion.Panel>
                                <p>
                        ...
                        <Accordion.Section id="exec-order">
                            <Accordion.Title>
                                <strong>
                                    Perintah Eksekutif 13627, Memperkuatkan Pelindungan ke atas Pemerdagangan
                                    Manusia dalam Kontrak dengan Kerajaan, dan melaksanakan Peraturan Pemerolehan Persekutuan
                                </strong>
                            </Accordion.Title>
                            <Accordion.Panel>
                                <p>
                                    Peraturan Pemerolehan Persekutuan Memerangi Pemerdagangan Manusia,
                                    berkuatkuasa mulai 2 Mac, 2015, melaksanakan perlindungan anti-pemerdagangan{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    sub-kontraktor dan pekerja sub-kontraktor daripada terlibat dalam aktiviti berkaitan pemerdagangan. Ini termasuk memusnahkan dan merampas dokumen
                                    pengenalan, mengamalkan penyelewengan dalam pengambilan pekerja, sering gagal memberikan kos pengangkutan balik bila tamat tempoh pekerjaan,
                                    gagal memberikan kontrak pekerjaan secara bertulis, menyediakan perumahan yang tidak memenuhi standard, dan mengenakan yuran pengambilan pekerja
                                    terhadap pekerja. Kontraktor diminta untuk mengambil tindakan sewajarnya terhadap pekerja, ejen dan sub-kontraktor yang melanggar larangan tersebut
                                    dan mesti memberitahu pekerja mereka tentang aktiviti yang dilarang dan akibatnya. Selain itu, di mana kontrak melebihi $500,000 dilakukan di luar
                                    Amerika Syarikat, kontraktor mesti membuat rancangan pematuhan dengan pekerja dan program kesedaran untuk pekerja melaporkan pencabulan, rancangan perumahan,
                                    dan rancangan gaji dan waktu bekerja. Kontraktor sedemikian mesti mengesahkan setiap tahun bahawa mereka melaksanakan rancangan mereka dan bahawa mereka
                                    atau sub-kontraktor mereka tidak terlibat dalam amalan yang dilarang, atau jika pelanggaran didapati di rantai bekalan mereka bahawa mereka telah mengambil
                                    tindakan pemulihan dan rujukan sewajarnya.
                                </p>
                                <p>
                                    The{" "}
                                    <a
                        ...
                        <Accordion.Section id="trade-act">
                            <Accordion.Title>
                                <strong>
                                    Akta Pengendalian Perdagangan dan Penguatkuasaan Perdagangan
                                </strong>
                            </Accordion.Title>
                            <Accordion.Panel>
                                <p>
                                    ...
                                    dihasilkan atau dikeluarkan sepenuhnya atau sebahagiannya” oleh banduan, buruh paksa atau buruh
                                    kontrak yang telah lama dilarang masuk ke AS di bawah{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    membenarkan Kastam dan Perlindungan Sempadan (Customs and Border Protection - CBP) menghindar produk yang
                                    dibuat oleh buruh paksa masuk ke AS walaupun terdapat permintaan di AS. Sesiapapun boleh melaporkan kepada
                                    CBP maklumat yang menunjukkan bahawa barang dagangan yang dihasilkan oleh buruh paksa sedang, atau kemungkinan
                                    akan diimport ke AS. If Jika maklumat itu munasabah, tetapi tidak meyakinkan, menunjukkan bahawa barang yang
                                    dilindungi telah dibuat, baik secara keseluruhan atau sebahagian oleh buruh paksa, CBP akan mengeluarkan  a&nbsp;
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    Buletin Pendaftaran Persekutuan dan Kastam dan merampas barang-barang tersebut.
                                </p>
                            </Accordion.Panel>
                        </Accordion.Section>
                        <Accordion.Section id="uk-slave-act">
                            ...
                            <Accordion.Panel>
                                <p>
                                    ...
                                    langkah-langkah yang diambil untuk memerangi perhambaan dan pemerdagangan manusia. Undang-undang tidak menetapkan
                                    jenis langkah yang syarikat harus dedahkan atau keperluan mengenai berapa banyak perincian yang harus diberikan oleh
                                    syarikat. Sebuah syarikat boleh mematuhi dengan mencatat dalam penyataannya bahawa pihaknya tidak mengambil langkah
                                    untuk memerangi perhambaan atau pemerdagangan manusia Kenyataan itu mesti disiarkan di laman web syarikat di bahagian
                                    utama. Tidak ada hukuman sekiranya tidak mematuhi. Undang-undang ini juga menetapkan hukuman minimum untuk jenayah
                                    perhambaan, memperkenalkan pembelaan untuk mangsa perhambaan, dan pemerdagangan manusia, dan memberi setiausaha negara
                                    dan penguatkuasaan undang-undang kuasa tambahan yang berkaitan dengan memerangi perhambaan, antara langkah-langkah
                                    lain yang berkaitan dengan penguatkuasaan.&nbsp;
                                </p>
                                <p>
                                    Sila lihat juga{" "}
                                    <a
                                    ...
                                    , satu laman web yang dikendalikan oleh Pusat Sumber Perniagaan dan Hak Asasi Manusia yang mengumpul dan memaparkan
                                    kenyataan syarikat-syarikat mengenai perhambaan moden di bawah Akta. Jawatankuasa Pendaftaran Tadbir Urus ini merangkumi{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                        ...
                        <Accordion.Section id="france-dov-law">
                            ...
                            <Accordion.Panel>
                                <p>
                                    ...
                                    yang menjalankan perniagaan di Perancis untuk membuat atau melaksanakan pelan berjaga-jaga.
                                    Pelan tersebut harus mengenal pasti risiko dan mengelakkan pencabulan hak asasi manusia
                                    seperti buruh kanak-kanak, buruh paksa, dan pemerdagangan akibat aktiviti syarikat, anak
                                    syarikat dan mana-mana sub-kontraktor yang digunakan oleh syarikat atau anak syarikatnya.
                                    Pelan berjaga-jaga mesti termasuk (1) prosedur untuk mengenal pasti risiko; (2) cara untuk
                                    memantau subsidiari atau sub-kontraktor; (3) pendekatan secukupnya untuk mengendali risiko dan
                                     menjauhi kecederaan yang serius (4) cara untuk melapor risiko; dan (5) cara untuk memantau
                                     keberkesanan langkah untuk mencegah. Mangsa atau pihak yang terlibat boleh memaklumkan mahkamah
                                      mengenai kegagalan syarikat untuk membuat pelan atau melaksanakan pelan, dan syarikat boleh diarah
                                      untuk melaksanakan pelan untuk memberi pampasan kepada mangsa yang menderita akibat syarikat tidak
                                      patuh dan melanggar tanggungjawabnya untuk prihatin.
                        ...
                        <Accordion.Section id="wall-street-prot-act">
                            <Accordion.Title>
                                <strong>
                                    Akta Membentuk Semula Wall Street dan Pelindungan Pengguna Dodd-Frank
                                </strong>
                            </Accordion.Title>
                            <Accordion.Panel>
                                <p>
                                    ...
                                    bekalan korporat di bawah Seksyen 1502. Kongres menggubal Seksyen 1502 disebabkan kebimbangan bahawa eksploitasi dan perdagangan mineral
                                    ...
                                    tersebut, syarikat juga diminta untuk menyediakan laman web mereka dengan maklumat yang mereka dedahkan kepada SEC.
                                </p>
                                <p>
                        ...
                        <Accordion.Section id="cali-supply-chain-act">
                            ...
                            <Accordion.Panel>
                                <p>
                                    ...
                                    kepada syarikat bersaiz sederhana dan peruncit bersaiz besar serta syarikat pembuatan dengan pendapatan sedunia berjumlah $100 juta atau
                                    lebih. Tujuan utamanya ialah untuk memastikan bahawa syarikat-syarikat menyediakan untuk pelanggan mereka maklumat yang mereka boleh gunakan
                                    untuk memahami syarikat mana yang bertanggungjawab mengelola rantai bekalan mereka. Dianggarkan bahawa keperluan untuk membuat laporan akan
                                    memberi kesan kepada kira-kira 3,200 syarikat yang beribu pejabat di California atau menjalankan perniagaan di negeri tersebut.
                                </p>
                                <p>
                                    Khususnya, undang-undang memerlukan syarikat untuk mendedahkan dalam laman web mereka inisiatif mereka untuk membasmi perhambaan dan
                                    pemerdagangan manusia daripada rantai bekalan langsung mereka untuk barangan yang dijual. Sesebuah syarikat mesti mendedahkan sejauh
                                    mana ia: (1) melakukan pengesahan rantaian bekalan produk untuk menilai dan menangani risiko pemerdagangan manusia dan perhambaan;
                                    (2) menjalankan audit pembekal; (3) menghendaki pembekal langsung untuk mengesahkan bahan yang dimasukkan ke dalam produk mematuhi
                                    undang-undang mengenai perhambaan dan perdagangan manusia di negara-negara di mana mereka menjalankan perniagaan; (4) menjaga standard
                                    dan prosedur kebertanggungjawapan pekerja atau kontraktor yang tidak memenuhi standard syarikat mengenai perhambaan dan pemerdagangan manusia;
                                    dan (5) memberikan latihan kepada pekerja dan pengurusan mengenai perhambaan dan pemerdagangan manusia.
                                </p>
                                <p>
                                    Lihat juga{" "}
                                    <a
                                ...
                                <p>
                                Lihat juga Akta Ketelusan dalam Rantai Bekalan California, satu pandangan dari dalam yang disediakan oleh&nbsp;
                                <a
                                    target="_blank"
                                    rel="noopener noreferrer"
                                ...
                                >
                                KnowTheChain
                                </a>, inisiatif yang dipimpin oleh&nbsp;
                                <a
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    href="https://humanityunited.org/"
                        ...
                        <Accordion.Section id="aust-slav">
                            <Accordion.Title>
                                <strong>
                                    Akta Perhambaan Moden Australia

                                </strong>
                            </Accordion.Title>
                            <Accordion.Panel>
                                <p>
                                    Pada Januari 1, 2019, (Akta)&nbsp;
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    kenyataan mengenai perhambaan moden. Kenyataan juga mesti menjelaskan risiko perhambaan moden
                                    dalam rantai bekalan entiti yang melaporkan (dan entiti yang ia milik dan kawal), serta langkah
                                    yang telah diambil terhadap risiko yang dikenalpasti termasuk ketekunan wajar dan proses
                                    pemulihan. Kerajaan Australia juga telah mengeluarkan&nbsp;
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                        ...
                        <Accordion.Section id="ductch-labor">
                            ...
                            <Accordion.Panel>
                                <p>
                                    Senat Netherlands meluluskan (Akta)&nbsp;
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    pelanggan Belanda, tidak kira di mana syarikat didaftar atau beroperasi. Akta memerlukan syarikat
                                    untuk memberi kenyataan bahawa mereka telah mengambil ketekunan wajar untuk menilai sama ada “syak
                                    munasabah” wujud bahawa barangan telah dikeluarkan oleh buruh kanak-kanak dalam rantai nilai mereka.
                                    “Sekiranya “syak munasabah” didapati, syarikat mesti menerap dan melaksana pelan untuk menangani
                                    buruh kanak-kanak. Syarikat juga mesti menyiasat bahawa buruh kanak-kanak dalam rantai bekalan mereka
                                    menggunakan sumber yang diketahui dan boleh diakses. Syarikat yang tidak mematuhi undang-undang boleh
                                    didenda sebanyak €870,000 atau sepuluh peratus daripada pendapatannya di seluruh dunia dan terdapat
                                    juga liabiliti jenayah terhadap pengarah.
                                </p>
                        ...
                        <Accordion.Section id="eu-report">
                            <Accordion.Title>
                                <strong>
                                EU Arahan Laporan Bukan Kewangan (2014/95/EU)
                            ...
                            <Accordion.Panel>
                                <p>
                                    ...
                                    kakitangan, menghormati hak asasi manusia, anti-rasuah dan rasuah, dan kepelbagaian dalam lembaga pengarah.
                                    Pada Jun 2017, Suruhanjaya Eropah menerbitkan&nbsp;
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
