        ...
        <div>
            ...
            <div className="indent-margin">
                ...
                <p className="indent-margin">
                    ...
                    these issues can yield lasting long-term benefits, and is
                    likely to be more effective when several companies join
                    together.
                </p>
                ...
                <p className="indent-margin">
                    ...
                    maintain a standing group of contributors who provide ideas
                ...
                <p className="indent-margin">
                    ...
                    people is important to get an accurate idea of risks, as
                ...
                <p className="indent-margin">
                    ...
                    for instance, ensuring that training materials are
                ...
                <p className="indent-margin">
                    ...
                    union is present, while some civil society groups specialize
                    in setting up grievance mechanisms and other communication
            ...
            <div className="own-words">
                ...
                <p>
                    &ldquo;Stakeholder engagement can take many forms. It can be
                    initiated by an organization or it can begin as a response
                    by an organization to one or more stakeholders. It can take
                    place in either informal or formal meetings and can follow a
                    wide variety of formats such as individual meetings,
                    conferences, workshops, public hearings, round-table
                    discussions, advisory committees, regular and structured
                    information and consultation procedures, collective
                    bargaining and web-based forums. Stakeholder engagement
                    should be interactive and is intended to provide
                    opportunities for stakeholders&rsquo; views to be heard. Its
                    essential feature is that it involves two-way
                    communication.&rdquo;
                </p>
                <p>
                    <em>
