    ...
    return (
        <div>
            ...
            <p>
                ...
                companies. Some codes are stand-alone documents, while others
                are presented within broader statements of company mission,
                values or policies. Some are included in supplier guidance
                documents that include other requirements, such as product
                quality. Increasingly, companies are including code of conduct
                language in multiple documents, as social compliance
                considerations become more interwoven within corporate strategy
                across business units.
            </p>
            <p>
                Some code documents are very general&mdash;merely laying out the
                broad areas of compliance&mdash;while others are much more
                detailed. In either case, the code typically is a foundation for
            ...
            <h2>Example Codes</h2>
            <p>
                The following examples demonstrate the various forms that codes
                can take:
            </p>
            <ul>
                <li>
            ...
            <p>
                ...
                clearly the actors within the company that are responsible for
                its development, oversight and implementation which should
                include the Board of Directors and senior management, as well as
                all of the business units involved in social compliance.
                Publishing the code communicates to all of your stakeholders
                that social compliance is valued at the highest levels of the
                company and that the company expects to be scrutinized for its
                degree of compliance.&nbsp;
            </p>
            <h2>The Content of Codes</h2>
            <p>
                The content of codes has become more standardized in recent
                years, consolidating around core content areas that generally
                include:
            </p>
            <ul>
                ...
                <li>
                    ...
                    <em>
                        (note: while these standards are often included in the
                        larger code of conduct, they are not discussed further
                        in this App due to its focus on child labor and forced
                        labor)
                    </em>
                </li>
                <li>
            ...
            <p>
                With respect to labor standards, a strong code should address
                areas covered by the International Labor Organization&rsquo;s
            ...
            <p>
                ...
                standards, referred to as conventions and recommendations, in
                all of these areas. When a national government ratifies a
                convention, it is expected to take the necessary measures to
                ensure that its laws and practices conform to the provisions of
                the convention. The country is also expected to report to the
                ...
                ratified the corresponding conventions must periodically report
                to the ILO on the realization of those rights.
            </p>
            <p>
            ...
            <p>
                ...
                designed for governments, the underlying principles in them can
                and should be applied by companies.Today, most companies,
                industries and multi-industry coalitions with codes base their
                labor standards on the ILO conventions. In cases where national
                laws set lower standards than the ILO conventions&mdash;for
                example, with respect to the minimum age for
                work&mdash;companies should incorporate the ILO standard into
                their codes. Where national laws are equal to or more stringent
                than ILO standards, the code should meet or exceed national
                laws.
            </p>
            <p>
                ...
                technical advice to users on the ILO&rsquo;s international labor
                standards and on the Tripartite Declaration of Principles
