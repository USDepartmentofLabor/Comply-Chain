    ...
    return (
        <div>
            ...
            <p>
                ...
                pas un grand nombre des probl&egrave;mes du travail sur les
                sites de r&eacute;colte, d&apos;exploitation mini&egrave;re et
                de production, dans les installations de transformation et sur
                les autres lieux de travail. Une formation et une communication
                permanentes, le renforcement des capacit&eacute;s et
                l&apos;accent mis sur le perfectionnement constant se sont
                r&eacute;v&eacute;l&eacute;s &ecirc;tre la voie la plus efficace
                vers des progr&egrave;s durables dans le sens d&apos;une
            ...
            <p>
                ...
                contrema&icirc;tres de vos fournisseurs, les travailleurs dans
                les &eacute;tablissements de l&apos;ensemble de votre
                cha&icirc;ne d&apos;approvisionnement, les pouvoirs publics, les
                organisations de travailleurs, les groupes communautaires et
                autres. Il y sera &eacute;galement pr&eacute;cis&eacute; comment
                rendre votre code plus accessible pour les parties prenantes en
                &eacute;vitant le jargon technique inutile et en fournissant une
                traduction dans diff&eacute;rentes langues.
            </p>
            <p>
                <em>
