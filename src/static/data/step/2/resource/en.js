        ...
        <div>
            ...
            <ol>
                ...
                <li>
                    ...
                    <em>
                        General principles &amp; operational guidelines for fair
                        recruitment, 2016;
                    </em>{" "}
                    available from{" "}
                    <a
                ...
                <li>
                    ...
                    Standards and national labor and social security laws, has a
                    table of Ratifications of the Fundamental human rights
                    Conventions by country, including UN Conventions pertaining
                ...
                <li>
                    ...
                    Labour (SIMPOC) is the statistical arm of ILO-IPEC, and
                    provides data on the extent, characteristics and
                    determinants of child labour. SIMPOC also assists countries
                    in the collection, documentation, processing and analysis of
                    child labour relevant data.
                </li>
                <li>
                    International Trade Union Confederation.{" "}
                    <em>
                        Global Rights Index: The World&rsquo;s Worst Countries
                        for Workers; 2014. ;{" "}
                    </em>
                    available from{" "}
                ...
                <li>
                    ...
                    Surveys (MICS); household surveys on a range of indicators
                    of children&rsquo;s well-being, including child labor. The
                    MIC reports and datasets are available by country.
                </li>
                <li>
