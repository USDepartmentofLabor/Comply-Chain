    ...
    return (
        <div>
            ...
            <ol>
                ...
                <li>
                    Human Rights Watch, [en la web, consultado el 7 de junio de
                ...
                <li>
                    ...
                    <em>
                        ...
                        Empresariales.{" "}
                        <i>
                            Gu&iacute;a de Evaluaci&oacute;n y Gesti&oacute;n
                            del Impacto a los Derechos Humanos (EGIDH)
                        </i>
                    </em>
                    . 2010; disponible en{" "}
                    <a
                ...
                <li>
                    Organizaci&oacute;n Internacional del Trabajo.{" "}
                    <i>
                        Sistema de informaci&oacute;n NORMLEX sobre las Normas
                        Internacionales del Trabajo
                    </i>
                    , [en la web, consultado el 7 de junio de 2017]; disponible
                    en{" "}
                    <a
                    ...
                    :::. NORMLEX, la base de datos de la OIT que contiene las
                    Normas Internacionales del Trabajo y la legislaci&oacute;n
                    nacional sobre trabajo y seguridad social, tiene un cuadro
                    de ratificaciones de los convenios sobre derechos humanos
                    fundamentales por pa&iacute;s, incluidos los convenios de
                    las Naciones Unidas en materia de trabajo infantil y trabajo
                    forzoso.
                </li>
                <li>
                    OIT-IPEC.{" "}
                    ...
                    . El Programa de informaci&oacute;n estad&iacute;stica y de
                    seguimiento en materia de trabajo infantil (SIMPOC) es la
                    secci&oacute;n estad&iacute;stica del IPEC de la OIT y
                    brinda datos sobre el alcance, las caracter&iacute;sticas y
                    los factores determinantes del trabajo infantil. SIMPOC
                    asiste tambi&eacute;n a los pa&iacute;ses en la
                    recolecci&oacute;n, documentaci&oacute;n, el procesamiento y
                    an&aacute;lisis de datos pertinentes sobre el trabajo
                    infantil.
                </li>
                <li>
                    ...
                    <em>
                        ...
                        <i> </i>
                        <i>
                            Los peores lugares del mundo para los trabajadores y
                            trabajadoras
                        </i>
                        ; 2014 ;{" "}
                    </em>
                    disponible en{" "}
                    <a href="http://www.ituc-csi.org/IMG/pdf/survey_ra_2014_eng_v2.pdf">
                ...
                <li>
                    ...
                    enero de 2017; disponible en idioma ingl&eacute;s solamente
                    en{" "}
                    <a
                ...
                <li>
                    ...
                    bienestar de los ni&ntilde;os, incluido el trabajo infantil.
                    Los informes de MIC y los conjuntos de datos est&aacute;n
                    disponibles por pa&iacute;s.
                </li>
                <li>
                    Departamento de Trabajo de los Estados Unidos. Datos de
                    ejecuci&oacute;n. [en la web, consultado el 7 de junio de
                    2017]; disponible en idioma ingl&eacute;s solamente en{" "}
                    <a href="https://enforcedata.dol.gov/homePage.php">
                        https://enforcedata.dol.gov/homePage.php
                    </a>
                    .
                </li>
                <li>
                    Departamento de Trabajo de los EE.UU., Direcci&oacute;n de
                    Asuntos Laborales Internacionales (ILAB).{" "}
                    <em>Lista del Decreto 13126,</em> Washington, DC; disponible
                ...
                <li>
                    ...
                    . Washington, DC, 2010; disponible en idioma ingl&eacute;s
                    solamente en{" "}
                    <a
                ...
                <li>
                    ...
                    >
                        Oficina para Controlar y Combatir la Trata de Personas
                    </a>
                    . <em>Informes sobre la trata de personas. </em>Washington,
                    DC. disponible en{" "}
                    <a
