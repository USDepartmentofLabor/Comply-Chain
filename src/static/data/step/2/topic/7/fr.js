        ...
        <StaticData>
            <div>
                ...
                <p>
                    ...
                    avoir un syst&egrave;me d&apos;information pour g&eacute;rer
                    toutes ses donn&eacute;es. Toutes les informations
                    tir&eacute;es de la cartographie et de
                    l&apos;&eacute;valuation des risques et des incidences
                    devraient &ecirc;tre entr&eacute;es syst&eacute;matiquement
                    dans ce syst&egrave;me et mises &agrave; jour
                    p&eacute;riodiquement.
                </p>
                <p>
                    La quasi-totalit&eacute; des &eacute;valuations des risques
                    et des incidences, quelle que soit l&apos;industrie,
                    identifiera des risques de violations des droits du travail
                    et peut-&ecirc;tre des incidences n&eacute;gatives que vous
                    avez d&eacute;j&agrave; caus&eacute;es. Vous devrez alors
                    prendre des d&eacute;cisions quant aux actions
                    n&eacute;cessaires pour les att&eacute;nuer ou y
                    rem&eacute;dier.
                </p>
                <p>
                    Si l&rsquo;&eacute;valuation des risques et des incidences
                    r&eacute;v&egrave;le que les pratiques de
                    l&rsquo;entreprise, notamment en mati&egrave;re de
                    sour&ccedil;age, contribuent directement &agrave; des
                    incidences n&eacute;gatives ou &agrave; des risques ou sont
                    source de tels probl&egrave;mes, la premi&egrave;re mesure
                    &agrave; prendre sera de rem&eacute;dier &agrave; ces
                    incidences et de s&apos;attaquer &agrave; ces
                    probl&egrave;mes en interne. Aussi difficile que ce
                    processus puisse &ecirc;tre, vous ne serez pas en mesure de
                    g&eacute;rer les risques externes de fa&ccedil;on efficace
                    si vous ne g&eacute;rez pas d&apos;abord les risques
                    internes.
                </p>
                <p>
                    ...
                    indiquer si les risques sont &eacute;ventuellement trop
                    importants. Si les risques sont substantiels, il conviendra
                    ...
                    l&apos;&eacute;tape suivante sera de trouver des
                    fournisseurs qui prendront part &agrave; votre programme de
                    conformit&eacute; sociale et travailleront avec vous
                    &agrave; son am&eacute;lioration constante. Ces engagements
                    devraient &ecirc;tre codifi&eacute;s dans les contrats
                    pass&eacute;s avec vos fournisseurs ; de nombreuses
                    entreprises exigent que leurs nouveaux fournisseurs
                    r&eacute;pondent aux r&eacute;f&eacute;rences de
                    conformit&eacute; sociale avant qu&apos;ils ne puissent
                    vendre &agrave; l&apos;entreprise.
                </p>
                <p>
                    Si vous vous approvisionnez dans une r&eacute;gion o&ugrave;
                    la sous-traitance est intense, vous pouvez d&eacute;cider de
                    restreindre le volume de la production qui sera
                    sous-trait&eacute;e par vos fournisseurs &agrave; des
                    entit&eacute;s ext&eacute;rieures. Cette limitation devra
                    alors &ecirc;tre incluse dans les contrats, pour &ecirc;tre
                    ensuite surveill&eacute;e et appliqu&eacute;e.
                </p>
                <p>
                    Si votre &eacute;valuation des risques et des incidences est
                    centr&eacute;e sur votre groupe de fournisseurs connus, les
                    &eacute;tapes suivantes d&eacute;pendront de leur
                    performance. Si des abus patents se produisent ou s&apos;ils
                    risquent de se produire, vous devriez tenter de travailler
                    avec les fournisseurs pour y rem&eacute;dier ou pour
                    am&eacute;liorer leurs politiques et processus. Si une
                    entreprise n&apos;a pas suffisamment d&apos;influence sur un
                    fournisseur pour qu&apos;il change de comportement, vous
                    pouvez tenter d&apos;accro&icirc;tre votre influence en
                    collaborant avec d&apos;autres acheteurs ou en offrant,
                    &agrave; titre d&apos;incitation, un renforcement des
                    capacit&eacute;s. Si le fournisseur ne r&eacute;agit pas
                    &agrave; ces efforts, il conviendrait d&rsquo;envisager de
                    mettre fin &agrave; votre relation d&apos;approvisionnement,
                    tout en tenant compte des incidences de cette rupture sur
                    les travailleurs et en tentant d&apos;en att&eacute;nuer, ce
                    faisant, les incidences.
                </p>
                <p>
                    Dans certains cas, une &eacute;valuation des risques et des
                    incidences identifiera un motif sp&eacute;cifique
                    sous-jacent des violations des droits du travail, et les
                    actionnaires pourront eux aussi proposer des id&eacute;es
                ...
                <p>
                    ...
                    l&apos;entreprise dans la formation et l&apos;appui
                    destin&eacute;s aux fournisseurs. Toutefois, les entreprises
                    adoptent un mod&egrave;le d&apos;investissement initial dans
                    le renforcement des capacit&eacute;s des vendeurs, des
                    agents et des fournisseurs, pour les tenir ensuite
                    responsables de la performance de la conformit&eacute;
                    sociale, mod&egrave;le qui peut se r&eacute;v&eacute;ler
                    rentable &agrave; longue &eacute;ch&eacute;ance. Ces
                ...
                <p>
                    Lorsque vous investissez dans une &eacute;valuation des
                    risques et des incidences qui rep&egrave;re les risques, et
                    que vous les att&eacute;nuez, n&apos;oubliez pas de faire
                    conna&icirc;tre ces efforts par la communication. Les
                    parties qui ont contribu&eacute; &agrave;
                    l&apos;&eacute;valuation des risques et des incidences
                    m&eacute;ritent une «&nbsp;boucle de retour
                    d&apos;information&nbsp;» sur la fa&ccedil;on dont leurs
                    informations ont &eacute;t&eacute; utilis&eacute;es. Si vous
                    avez agi &agrave; partir d&apos;informations issues
                    d&apos;un processus ou d&apos;un m&eacute;canisme de
                    plaintes, vous devriez rendre compte de ces actions. Les
                    informations sur votre &eacute;valuation des risques et des
                    incidences et sur l&apos;att&eacute;nuation devraient
                    &eacute;galement se trouver dans les rapports publics de
                    l&rsquo;entreprise.
                </p>
                <p>
                    Et enfin, les activit&eacute;s d&apos;&eacute;valuation des
                    risques et des incidences devraient &ecirc;tre permanentes
                    et il vous faudrait actualiser r&eacute;guli&egrave;rement,
                    dans votre syst&egrave;me d&apos;information, les
                    renseignements de la cartographie. Les risques de
                    conformit&eacute; sociale changent au fil du temps, avec
