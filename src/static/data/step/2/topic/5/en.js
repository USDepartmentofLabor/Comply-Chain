        ...
        <StaticData>
            <div>
                ...
                <p>
                    ...
                    assessments are becoming increasingly common, and
                    comprehensive tools are available to walk companies through
                    the process. These include the{" "}
                    <a
                        target="_blank"
                ...
                <p>
                    An early step in your risk and impact assessment should be
                    to examine the various products you market and sell to
                    identify those that are more likely to be produced by child
                    or forced labor. A useful resource for this is the
                    Department of Labor&rsquo;s{" "}
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    report. Sweat &amp; Toil, whose contents are also available
                    on the International Child Labor &amp; Forced Labor Reports
                    section of the{" "}
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <ExampleInAction id="fish">
                    ...
                    <p>
                        Child labor and forced labor are used to catch and
                        process fish and seafood in a range of aquatic
                        environments around the world. The isolated nature of
                        work on waters presents a number of challenges to child
                        labor and forced labor law enforcement in fishing and
                        seafood. The{" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        maritime law at sea. The Convention distinguishes
                        between different maritime areas&mdash;territorial sea,
                        Exclusive Economic Zones, and the high seas&mdash;and
                        countries&rsquo; ability to regulate activities within
                        each of these. These maritime boundaries add an
                        additional layer of complexity to enforcing labor laws
                        on fishing vessels. The country with its flag on a
                        fishing vessel generally has the responsibility for
                        regulating labor conditions on that vessel. However,
                        when flagging states are unable or unwilling to enforce
                        labor laws on their vessels, workers can become
                        increasingly vulnerable to exploitation. While ships may
                        not change their flags during a voyage, vessels have
                        been known to use so-called flags of convenience, or the
                        flag of a state other than that of the vessel&rsquo;s
                        owner, to avoid financial or regulatory charges in that
                        state, as well as to subject themselves to a
                        state&rsquo;s labor regime they deem beneficial.
                        Enforcement, prosecution, and restitution efforts are
                        further complicated when vessels operate within the
                        territorial jurisdiction of another state.&nbsp;
                    </p>
                    <p>
                        Illegal, unreported, and unregulated (IUU) fishing has
                        become an ever- growing problem. IUU fishing depletes
                        global seafood stocks and creates unfair competition
                        within the seafood industry, including by exploiting
                        workers. Governments have been increasing efforts
                        related to IUU fishing. For example, under its IUU
                        regulation, the European Union has issued
                        pre-identifications, better known as &ldquo;yellow
                        cards&rdquo;, to countries that it deems are not doing
                        enough to combat IUU fishing. Issuance of a yellow card
                        initiates a formal dialogue with the government in
                        question regarding corrective measures. The U.S.
                        government is also taking action to address IUU fishing:
                        a Presidential Task Force on Combatting IUU Fishing
                        released an{" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                ...
                <OwnWords>
                    ...
                    <p>
                        ...
                        on a screening of labor-related factors.
                    </p>
                    <p>
                        &nbsp;&ldquo;Special Consideration projects are
                        considered to have heightened potential for adverse
                        project-related social risks associated with the
                        involvement of or impact on Project Affected People
                        including Workers. Projects may be classified as Special
                        Consideration based on an assessment of the severity of
                        possible social risks, and their relevance to a
                        project.&nbsp;
                    </p>
                    <p>
                    ...
                    <ul>
                        <li>
                            ...
                            sectors that are statistically more likely to
                            infringe upon Labor Rights.
                        </li>
                        <li>
                            Regional vulnerabilities: projects in countries (i)
                            with a documented history of Labor Rights issues,
                            (ii) having recently experienced conflict associated
                            with Project Affected People, or (iii) with weak or
                        ...
                        <li>
                            ...
                            Workers, including within the supply chain; (ii)
                            project risks or impacts that fall
                            disproportionately on Project Affected People who,
                            because of their particular circumstances, may be
                            disadvantaged or vulnerable, or (iii) sectors in
                            which there is a high risk for the use of forced
                            labor or child labor.
                        </li>
                        <li>
                            Significant adverse impacts: (i) projects
                            anticipated to have adverse impacts on a significant
                            numbers of Workers, or (ii) projects that by their
                            nature or footprint could cause or be anticipated to
                            cause (or be complicit in) significant adverse Human
                            Rights impacts.&rdquo;
                        </li>
                    </ul>
                    <p>
