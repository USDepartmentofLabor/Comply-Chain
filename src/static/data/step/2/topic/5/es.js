...
const es = () => {
    return (
        <StaticData>
            <div>
                <h1>
                    Recolecci&oacute;n de informaci&oacute;n sobre los riesgos y
                    el impacto
                </h1>

                <p>
                    Cada vez es m&aacute;s com&uacute;n hacer distintos tipos de
                    evaluaci&oacute;n de impacto y riesgos centrados en los
                    derechos humanos y se cuenta con instrumentos integrales
                    para acompa&ntilde;ar a las empresas en el proceso. Algunos
                    ejemplos son la{" "}
                    <a
                        target="_blank"
                ...
                <p>
                    Uno de los primeros pasos en la evaluaci&oacute;n de riesgos
                    e impacto debe ser examinar los diversos productos que
                    ...
                    actualiza peri&oacute;dicamente, es parte del mandato
                    emanado de la{" "}
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    >
                        Ley de reautorizaci&oacute;n de la protecci&oacute;n a
                        las v&iacute;ctimas de la trata de 2005 (TVPRA)
                    </a>
                ...
                <ExampleInAction id="med_rep">
                    ...
                    <p>
                        ...
                        empresas, a los consumidores y al p&uacute;blico en
                        general sobre el trabajo infantil y el trabajo forzoso.
                        En los &uacute;ltimos a&ntilde;os, numerosos medios de
                        ...
                        ladrillos de la India y las pr&aacute;cticas
                        fraudulentas de reclutamiento en la industria de la
                        construcci&oacute;n en el Oriente Medio, entre muchas
                        otras. En muchos casos, las principales fuentes de
                        informaci&oacute;n de los periodistas son representantes
                        de organizaciones de la sociedad civil que lucharon por
                        visibilizar el problema y que ahora tienen m&aacute;s
                        oportunidades de hacerlo.
                    </p>
                    <p>
                        Gracias a la investigaci&oacute;n y la
                        comunicaci&oacute;n de estas noticias, sabemos
                        m&aacute;s de las familias ind&iacute;genas que migran
                        por Am&eacute;rica Central trabajando en la zafra,
                        incluso personas mayores y ni&ntilde;os peque&ntilde;os.
                        Comprendemos m&aacute;s los tipos de leyes y
                        pol&iacute;ticas de los gobiernos, como las que vemos en
                        algunos pa&iacute;ses del Golfo, que pueden perpetuar el
                        trabajo forzoso ya que dejan a los trabajadores
                        migrantes vulnerables a las pr&aacute;cticas de
                        explotaci&oacute;n, como la confiscaci&oacute;n de los
                        pasaportes por parte de empleadores, el impago de
                        salarios y la sustituci&oacute;n contractual sin
                        consentimiento del trabajador.
                    </p>
                    <p>
                        Nos vamos enterando de los fuertes v&iacute;nculos que
                        existen entre el trabajo forzoso y la destrucci&oacute;n
                        del medio ambiente. En los lugares en que los bienes se
                        producen de manera ilegal o en que las fuerzas del orden
                        son endebles, tanto las personas como el medio ambiente
                        est&aacute;n en riesgo, como en las minas de oro,
                        industria con elevados niveles de producci&oacute;n
                        il&iacute;cita conocida por contaminar el agua potable y
                        la tierra con mercurio y cianuro y donde prolifera el
                        trabajo infantil. Nos enteramos de las an&eacute;cdotas
                        desoladoras detr&aacute;s del j&uacute;bilo de los mega
                        eventos deportivos: historias de trabajadores
                        enga&ntilde;ados a quienes se les paga una miseria para
                        construir estadios imponentes y que trabajan explotados
                        en talleres clandestinos para confeccionar la ropa y las
                        mercanc&iacute;as para estos eventos. Y todos nos vemos
                        invadidos por la aversi&oacute;n colectiva que despierta
                        la explotaci&oacute;n de los pescadores en el mar.
                    </p>
                    <p>
                        ...
                        responsable o al impulsar medidas tendientes a
                        garantizar que existan mecanismos de remediaci&oacute;n
                        y presentaci&oacute;n de reclamaciones para combatir las
                        infracciones laborales, los medios pueden
                        desempe&ntilde;ar una funci&oacute;n importante cuando
                        contribuyen a los esfuerzos de debida diligencia de las
                ...
                <p>
                    ...
                    trabajadores especialmente vulnerable al trabajo forzoso. En
                    la econom&iacute;a mundial, millones de trabajadores
                    abandonan sus hogares para trabajar en otros lugares en su
                    propio pa&iacute;s o en otra parte del mundo. Muchos
                    trabajadores migrantes en b&uacute;squeda de trabajo
                    depositan su confianza en reclutadores o intermediarios
                    laborales que les organizan el transporte y los ubican en un
                    trabajo pero muchos descubren, demasiado tarde, que sus
                    salarios y condiciones laborales no se condicen con las
                    promesas de los intermediarios. Durante el proceso de
                    reclutamiento, algunos trabajadores migrantes incurren en
                    grandes deudas y quedan atrapados en servidumbre por deudas
                    ante la imposibilidad de pagarlas. Los ciclos de servidumbre
                    por deudas tambi&eacute;n comienzan cuando los empleadores
                    realizan deducciones de los salarios obreros en concepto de
                    vivienda, alimentos y otros costos, con lo cual el salario
                    neto de los trabajadores resulta escaso o nulo. Muchos
                    ...
                    contrato. Algunos deben entregar sus documentos de identidad
                    a los empleadores, lo cual les impide huir de las
                ...
                <ul>
                    ...
                    <li>
                        <em>
                            ¿Trabajan los ni&ntilde;os principalmente en
                            empresas formales o informales?
                        </em>
                    </li>
                    <li>
                        <em>
                            ¿Cu&aacute;l es el problema principal: los
                            trabajadores menores de la edad legal para trabajar
                            o los que tienen la edad legal pero que realizan
                            tareas peligrosas?
                        </em>
                    </li>
                </ul>
                ...
                <ul>
                    <li>
                        <em>
                            ¿Qu&eacute; leyes nacionales existen sobre el
                            trabajo infantil que definen el trabajo admisible y
                            no admisible para los ni&ntilde;os? ¿Cu&aacute;les
                            son las disposiciones y definiciones?
                        </em>
                    </li>
                    <li>
                        <em>
                            ¿El pa&iacute;s ha ratificado el Convenio sobre la
                            edad m&iacute;nima (C.138) y el Convenio sobre las
                            peores formas de trabajo infantil (C.182) de la OIT?
                        </em>
                    </li>
                    <li>
                        <em>
                            ¿Acordaron los interlocutores sociales una lista de
                            lo que constituye &ldquo;trabajo peligroso&rdquo;?
                        </em>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        <em>
                            ¿Qu&eacute; ONG locales, nacionales e
                            internacionales desempe&ntilde;an una funci&oacute;n
                            activa en su zona en el campo del trabajo infantil?
                            ¿Hay grupos externos que vigilan y siguen la
                            cuesti&oacute;n u otros que puedan ayudar a las
                            empresas y a las organizaciones patronales a retirar
                            a los ni&ntilde;os del trabajo y ayudar a los padres
                            a incrementar los ingresos?
                        </em>
                    </li>
                    <li>
                        <em>
                            ¿Tienen entidades internacionales como la OIT o
                            UNICEF una presencia activa en el pa&iacute;s? ¿Y la
                    ...
                    <li>
                        <em>
                            ¿Qu&eacute; otros grupos empresariales, incluidas
                            las asociaciones del sector, mantienen una presencia
                            activa en el pa&iacute;s?
                        </em>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        <em>
                            ¿Reclamaron los productores por las numerosas
                            exigencias de los compradores?
                        </em>
                    </li>
                    <li>
                        <em>
                            ¿Se procur&oacute; coordinar entre los compradores
                            para acordar una serie com&uacute;n de normas?
                        </em>
                    </li>
                </ul>
                <p>
                    ...
                    , 2007, de la Organizaci&oacute;n Internacional del Trabajo
                    y la Organizaci&oacute;n Internacional de Empleadores.
                </p>
            </div>
        </StaticData>
    );
