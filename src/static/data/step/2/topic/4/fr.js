                ...
                <p>
                                ...
                                <ExampleInAction id="eicc">
                                    <h4>
                                        ...
                                        &nbsp;{": "}
                                        <strong>
                                            Code de conduite—Gestion de la Responsible Business Alliance (RBA) (anciennement Coalition pour la citoyenneté de l&apos;industrie électronique – EICC)
                                        </strong>
                                    </h4>
                                    <p>
                                    « Les Participants doivent adopter ou mettre en place un système de gestion dont le périmètre est lié au contenu de ce Code.
                                    Le système de gestion doit être conçu pour veiller à : (a) la conformité aux lois et réglementations applicables et aux
                                    exigences des clients liées à l&apos;exploitation et aux produits des participants ; (b) la conformité avec ce Code et (c)
                                    l’identification et l’atténuation des risques opérationnels liés à ce Code. Il doit également faciliter une amélioration continue.
                                    </p>
                                    <p>
                                    Extrait du{" "}
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        href="www.responsiblebusiness.org/media/docs/RBACodeofConduct6.0_English.pdf"
                                    >
                                    Code de conduite de la Responsible Business Alliance v. 6.0 (2018) 
                                    </a>
                                    ; disponible [en anglais] sur http://www.responsiblebusiness.org/media/docs/RBACodeofConduct6.0_English.pdf.
                                    </p>
                                </ExampleInAction>
            </div>
        </StaticData>
