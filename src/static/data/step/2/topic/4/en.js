...
const en = () => {
    return (
        <div>
            ...
            <p>
                Companies know who their direct suppliers are and where they are
                located. However, in many cases, companies source from vendors
                or agents who do not disclose the factories or other production
                facilities from which <em>they</em> in turn source. Oftentimes
                companies may be aware of the first-tier factories and
                production facilities in their supply chains, but know little or
                nothing about the practices of second, third and other tiers of
                suppliers down the line. Companies should know as much as
                possible about who supplies to them&mdash;at all levels of the
                supply chain, including producers of raw materials. The more
                comprehensively a company can map its supply chains, the more
                accurately it can identify those places along the chain with the
                greatest risks of labor abuses. It is therefore important to
                communicate with the company&rsquo;s sourcing and/or supply
                chain management teams to obtain data about their own supply
                chains, and if more information is needed, to work closely with
                them to supplement that data.
            </p>
            <p>
                If a company currently does not have access to information about
                suppliers beyond those from whom it sources directly, consider
                working with the legal department and/or other appropriate units
                in the company to create contractual requirements for disclosing
                comprehensive information about all of the suppliers.
            </p>
            <p>
                &ldquo;Mapping&rdquo; includes knowing not only who your
                suppliers are (throughout the supply chain), but also where they
                are located. This information is essential for risk and impact
                assessment related to legal and regulatory environments, among
                other things. This exercise may also include maps showing
                seasonality of production or production cycles throughout the
                year, as these may be tied to times of greater risk for labor
                abuses.&nbsp;
            </p>
            ...
            <p>
                Goods produced using agricultural or mineral commodities can be
                particularly difficult to trace, since the raw materials are
                harvested or mined in widely dispersed geographic areas and
                aggregated or co-mingled early in the supply chain. Some
                companies and industry coalitions have attempted
                &ldquo;traceability&rdquo; programs to track certain commodities
                from a finished product back through the supply chain to their
                point of origin.
            </p>
            <p>
                ...
                entities in their value chains it may be unreasonably difficult
                to conduct due diligence for adverse human rights impacts across
                them all. If so, business enterprises should identify general
                areas where the risk of adverse human rights impacts is more
                significant, whether due to certain suppliers&rsquo; or
                clients&rsquo; operating context, the particular operations,
                products or services involved, or other relevant considerations,
                and prioritize those for human rights due diligence.&rdquo; This
                prioritization process is addressed below.
            </p>
            <br />
