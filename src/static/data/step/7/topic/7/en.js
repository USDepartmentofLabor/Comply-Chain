                ...
                <ExampleInAction id="gap">
                    ...
                    In 2010, the Ethical Trading Initiative* published {" "}
                        ...
                        for both retailers and suppliers. These guidelines 
                            ...
                            research guides for identifying homework in supply chains, 
                            mapping tools, and guidance on setting appropriate piece 
                            rates, since homeworkers are usually paid on a piece 
                            rate basis.
                    </p>
                    <p>
                        And starting in 2019, as part of the {" "}
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        {" "}was developed, 
                        including practical guidance on addressing issues of child labor 
                        in homebased crafts production. The project aims to extend 
                        multi-stakeholder-led transparency and traceability systems to the 
                        lower tiers in the garment sector and improve working conditions of 
                        homeworkers in India, Nepal, and Pakistan as part of the apparel 
