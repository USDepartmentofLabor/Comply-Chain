    ...
    return (
        <StaticData>
            <div>
                ...
                <p>
                    Les formats des outils d&rsquo;audit varient ; certains sont sur papier (pour &ecirc;tre 
                    transcrits par la suite dans un syst&egrave;me &eacute;lectronique), alors que d'autres 
                    sont programm&eacute;s dans des ordinateurs de poche. Les outils &eacute;lectroniques ne 
                    sont pas forc&eacute;ment sup&eacute;rieurs aux outils sur support papier, mais ils 
                    permettent de rendre compte plus efficacement et rapidement aux membres de l'&eacute;quipe 
                    qui ne sont pas sur le terrain.
                </p>
                <p>
                    Les outils d&rsquo;audit sont en fait des s&eacute;ries de questions qui d&eacute;coulent 
                    directement du code de conduite ; dans un certain sens, ils &laquo; traduisent &raquo; les 
                    grandes d&eacute;clarations du code en des points de donn&eacute;es sp&eacute;cifiques qui 
                    doivent &ecirc;tre recueillis pour &eacute;valuer la conformit&eacute; avec le code.
                </p>
                <p>
                    Par exemple, en ce qui concerne le travail des enfants, un code de conduite pourrait &eacute;noncer:
                </p>
                <ul>
                    <li>
                        Les fournisseurs n'emploieront pas d'enfants de moins de 15 ans ou d'un &acirc;ge inf&eacute;rieur 
                        &agrave; l'&acirc;ge minimum d&rsquo;admission &agrave; l&rsquo;emploi d&eacute;fini par les lois 
                        locales, le plus &eacute;lev&eacute; &eacute;tant retenu.
                    </li>
                </ul>
                <p>
                    En se fondant sur cette disposition du code, l'outil d'audit m&egrave;nera alors l'auditeur &agrave; 
                    examiner les questions suivantes:
                </p>
                <ul>
                    <li>
                        Quelle preuve de documentation de l'&acirc;ge est exig&eacute;e au moment de l'embauche ? Comment 
                        cette documentation est-elle v&eacute;rifi&eacute;e ? O&ugrave; est conserv&eacute;e la 
                        documentation de preuve de l'&acirc;ge?
                    </li>
                    <li>
                        Si des enfants de moins de 15 ans se trouvent dans l'&eacute;tablissement, travaillent-ils dans le 
                        cadre d'un programme l&eacute;gal d'apprentissage ou de formation ? Quelle documentation 
                        l'&eacute;tablissement conserve-t-il pour v&eacute;rifier qu'il s'agit d'un programme l&eacute;gitime 
                        d'apprentissage ou de formation ?
                    </li>
                    <li>
                        Les enfants font-ils des &laquo; travaux l&eacute;gers &raquo; tels que d&eacute;finis par les lois 
                        locales ou par les normes internationales ? Comment l'&eacute;tablissement d&eacute;finit-il et 
                        documente-t-il les &laquo; travaux l&eacute;gers &raquo; ?
                    </li>
                    <li>
                        Quelles sont les conditions de travail de tous les mineurs de moins de 18 ans ? Quelles t&acirc;ches 
                        sp&eacute;cifiques accomplissent-ils ? De quels &eacute;quipements se servent-ils ? Ces t&acirc;ches 
                        ou ces &eacute;quipements peuvent-ils &ecirc;tre dangereux ?
                    </li>
                    <li>
                        Quelle distinction l'&eacute;tablissement fait-il entre les travaux dangereux ou pas, et comment 
                        s'assure-t-il que les mineurs de moins de 18 ans n'accomplissent pas de travaux dangereux, en 
                        contravention avec le droit international ?
                    </li>
                </ul>
                <p>
                    Le travail forc&eacute; est une violation extr&ecirc;mement complexe des droits du travail et il peut prendre 
                    de nombreuses formes. The document{" "}
                    <a
                        target="_blank"
                    ...
                    >
                        <em>
                            Combattre le travail forc&eacute; :manuel pour les employeurs et le secteur priv&eacute; &ndash; Brochure 4
                        </em>
                    </a>{" "}
                    de l&rsquo;OIT [en anglais], comprend une liste de contr&ocirc;le et des directives utiles aux auditeurs et 
                    au personnel en charge de la conformit&eacute; pour identifier les cas de travail forc&eacute; au niveau de 
                    l&rsquo;entreprise et dans les cha&icirc;nes d&rsquo;approvisionnement mondiales. En 2016, l&rsquo;OIT a 
                    &eacute;galement lanc&eacute; une application mobile,{" "}
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://www.ilo.org/global/publications/WCMS_460489/lang--en/index.htm"
                    ...
                    disponible en anglais, pour permettre aux entreprises, aux auditeurs et au personnel en charge de la 
                    conformit&eacute; de cr&eacute;er des listes de contr&ocirc;le interactives afin d&rsquo;aider &agrave; 
                    &eacute;liminer et &agrave; pr&eacute;venir le travail forc&eacute; dans les op&eacute;rations commerciales. 
                    Les questions suivantes, issues d&rsquo;une publication de l&rsquo;OIT, peuvent aider un auditeur &agrave; 
                    identifier des formes particuli&egrave;res de travail forc&eacute;.
                </p>
                <Accordion id="recruitment-indicator-acc">
                    <Accordion.Section id="recruitment-indicator-description">
                        <Accordion.Title>
                        Tableau 1 : Indicateurs de travail forc&eacute; obtenu par des pratiques de recrutement
                        </Accordion.Title>
                        <Accordion.Panel>
                        <ol>
                            <li>
                                Y a-t-il des travailleurs enlev&eacute;s, retenus pendant le processus de recrutement ou vendus pour ce travail ?
                            </li>
                            <li>
                                Y a-t-il des travailleurs enlev&eacute;s, retenus pendant le processus de recrutement ou vendus pour ce travail ?
                            </li>
                            <li>
                                Y a-t-il des travailleurs recrut&eacute;s sous une forme d'arrangement pour dettes, par exemple une avance ou 
                                un pr&ecirc;t, qu'ils travaillent &agrave; rembourser ?
                            </li>
                            <li>
                                Au moment du recrutement, y a-t-il des travailleurs auxquels on a dit qu'ils feraient un travail d'une nature 
                                diff&eacute;rente de celui qu'ils accomplissent ?
                            </li>
                            <li>
                                Au moment du recrutement, a-t-on promis &agrave; des travailleurs certaines conditions de travail, des 
                                modalit&eacute;s contractuelles d'emploi, des conditions d&rsquo;existence, des lieux de travail, des 
                                employeurs ou des salaires/des revenus diff&eacute;rents de ceux qu'ils ont &agrave; l'heure actuelle ?
                            </li>
                            <li>
                                Au moment du recrutement, a-t-on offert un mariage &agrave; certains travailleurs &agrave; titre d'incitation ?
                            </li>
                        </ol>
                        </Accordion.Panel>
                    </Accordion.Section>
                ...
                <Accordion.Section id="duress-indicator-description">
                    <Accordion.Title>
                    Tableau 2 : Indicateurs de travail forc&eacute; obtenu par un travail et des conditions d&rsquo;existence sous la contrainte
                    ...
                    <ol>
                        <li>
                            Y a-t-il des travailleurs qui font des heures suppl&eacute;mentaires excessives, au-del&agrave; des 
                            limites pr&eacute;vues par la loi ?
                        </li>
                        <li>
                            Y a-t-il des travailleurs contraints d&rsquo;effectuer des astreintes (jour ou nuit) ?
                        </li>
                        <li>
                            L'employeur restreint-il la libert&eacute; de d&eacute;placement ou de communication des travailleurs 
                            avec des tiers, &agrave; l'int&eacute;rieur ou &agrave; l'ext&eacute;rieur du lieu de travail ?
                        </li>
                        <li>
                            Si l'employeur fournit un logement aux travailleurs, les conditions d&rsquo;existence sont-elles d&eacute;gradantes ?
                        </li>
                        <li>
                            L'employeur contraint-il les travailleurs &agrave; ex&eacute;cuter des activit&eacute;s illicites, &agrave; 
                            travailler pour son domicile priv&eacute; ou sa famille ou &agrave; prendre des drogues toxicomanog&egrave;nes ?
                        </li>
                        <li>
                            L'employeur impose-t-il aux travailleurs des dettes ou les amplifie-t-il, par exemple en falsifiant des 
                            registres, en gonflant les prix d'articles que les travailleurs sont contraints d'acheter, en r&eacute;duisant 
                            la valeur des articles ou des services produits par les travailleurs, en facturant des int&eacute;r&ecirc;ts 
                            excessifs sur les pr&ecirc;ts ou les avances accord&eacute;s aux travailleurs, etc. ?
                        </li>
                        <li>
                            Y a-t-il des travailleurs tributaires de l'employeur quant au logement, &agrave; la nourriture et aux 
                            autres produits de premi&egrave;re n&eacute;cessit&eacute; ?
                        </li>
                        <li>
                            Y a-t-il des travailleurs en relation de d&eacute;pendance avec l'employeur au-del&agrave; de leur emploi, 
                            par ex. rapports personnels, d&eacute;pendance vis-&agrave;-vis de l'employeur quant &agrave; l'emploi de 
            ...
            {/* </Accordion>
                ...
                <Accordion.Section id="impossible-leaving-description">
                    <Accordion.Title>
                    Tableau 3 : Indicateurs de travail forc&eacute; obtenu par l&apos;impossibilit&eacute; de partir

                    </Accordion.Title>
                    <Accordion.Panel>
                    <ol>
                        <li>
                            Y a-t-il des travailleurs qui estiment qu'ils ne sont pas libres de d&eacute;missionner en raison 
                            de la formation, ou d'autres avantages re&ccedil;us de l'employeur ?
                        </li>
                        <li>
                            Les travailleurs peuvent-ils mettre fin &agrave; leur emploi &agrave; tout moment, sans p&eacute;nalit&eacute; 
                            (sauf celles pr&eacute;vues par la loi) ?
                        </li>
                        <li>
                            Y a-t-il des travailleurs qui estiment devoir rester dans leur emploi car ils attendent qu'on leur verse 
                            les salaires qui leur sont dus ?
                        </li>
                        <li>
                            Y a-t-il des travailleurs qui travaillent pendant des p&eacute;riodes de dur&eacute;e excessive ou 
                            ind&eacute;finie pour rembourser une dette ou une avance re&ccedil;ue de l'employeur ou d'un recruteur ?
                        </li>
                    </ol>
                    </Accordion.Panel>
                </Accordion.Section>
            {/* </Accordion>
                ...
                <Accordion.Section id="human-traffic-description">
                    ...
                    <Accordion.Panel>
                    <p>
                        Si l'un des indicateurs ci-dessus est relev&eacute; (noter que l'un quelconque d'entre eux suffit et 
                        qu&rsquo;il n'est pas n&eacute;cessaire qu'il y ait un indicateur par tableau), l'auditeur devrait 
                        examiner si des sanctions ou des menaces servent &agrave; extorquer du travail. Si c'est le cas, la 
                        situation peut constituer du travail forc&eacute; :
                    </p>
                    <ol>
                    <li>
                        L'employeur (ou le recruteur) menace-t-il de remettre les travailleurs aux autorit&eacute;s publiques 
                        (p. ex. les autorit&eacute;s de l'immigration) ?
                    </li>

                    <li>
                        L'employeur (ou le recruteur) a-t-il pris possession des papiers d'identit&eacute; ou des titres de voyage des travailleurs ?
                    </li>

                    <li>
                        L'employeur restreint-il la communication des travailleurs, par exemple en confisquant les t&eacute;l&eacute;phones 
                        portables, en isolant des travailleurs des autres travailleurs, en enfermant les travailleurs dans leur lieu de travail 
                        ou dans leur logement, ou en les pla&ccedil;ant sous surveillance constante ?
                    </li>

                    <li>
                        L'employeur (ou le recruteur) exerce-t-il des violences physiques ou sexuelles sur les travailleurs, ou les en 
                        menace-t-il, y compris des ch&acirc;timents violents sur un travailleur devant les autres ?
                    </li>

                    <li>
                        L'employeur punit-il ou menace-t-il de punir les travailleurs par d'autres moyens, par exemple la privation de 
                        nourriture, d'eau ou de sommeil, ou en mena&ccedil;ant les membres de leur famille ?
                    </li>

                    <li>
                        L'employeur (ou le recruteur) menace-t-il de retirer des avantages, par exemple une promotion potentielle ?                
                    </li>

                    <li>
                        L'employeur menace-t-il d'une aggravation des conditions de travail ?
                    </li>

                    <li>
                        L'employeur (ou le recruteur) exploite-t-il les convictions religieuses ou culturelles des travailleurs pour les menacer ?
                    </li>

                    <li>
                        L'employeur (ou le recruteur) retient-il des biens des travailleurs, par exemple des effets personnels, de l'argent liquide, etc. ?
                    </li>

                    <li>L'employeur retient-il les salaires des travailleurs ?</li>

                    <li>
                        L'employeur menace-t-il de renvoyer/licencier des travailleurs ?
                    </li>

                    <li>
                        L'employeur menace-t-il de travail suppl&eacute;mentaire les travailleurs qui ne coop&egrave;rent pas ?
                    </li>

                    <li>
                        L'employeur menace-t-il de sanctions financi&egrave;res ?
                    </li>

                    <li>
                        L'employeur (ou le recruteur) menace-t-il de retenir des opportunit&eacute;s d'emploi futures, d'imposer des 
                        sanctions financi&egrave;res, d'exclure des travailleurs d'activit&eacute;s sociales ou communautaires, ou 
                        a-t-il recours &agrave; du chantage pour exercer des contraintes sur les travailleurs ?
                    </li>
                    </ol>
                    </Accordion.Panel>
                </Accordion.Section>
                ...
                <p>
                    De nombreuses entreprises ont l&rsquo;exclusivit&eacute; de leurs outils d'audit et il peut donc &ecirc;tre difficile 
                    de trouver des exemples pour orienter l&rsquo;&eacute;laboration de votre outil d'audit. L&rsquo;
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    (RST) comprend des r&eacute;f&eacute;rences en mati&egrave;re de recrutement et 
                    d&rsquo;emploi pour traduire en points de donn&eacute;es mesurables et exploitables les exigences et bonnes pratiques 
                    pr&eacute;cis&eacute;es dans ses Exemples de dispositions de code de conduite, qui sont r&eacute;f&eacute;renc&eacute;es 
                    &agrave; la{" "} 
                    <Link to="/steps/5">
                    troisi&egrave;me &eacute;tape, &Eacute;laborer un code de conduite
                    </Link>. 
                     Ces r&eacute;f&eacute;rences, qui couvrent 
                    toute une s&eacute;rie de domaines li&eacute;s au travail forc&eacute; et &agrave; la traite des personnes notamment les 
                    commissions de recrutement, les contrats de travail, la r&eacute;tention de documents et la libert&eacute; de circulation, 
                    peuvent constituer la base de l&rsquo;&eacute;laboration des instruments d&rsquo;audit et de la mise en place et de la 
                    surveillance d&rsquo;indicateurs de performance cl&eacute;s pour &eacute;valuer les r&eacute;sultats des fournisseurs et 
                    des agents de main d'&#339;uvre.
                </p>
                <ExampleInAction id="rst1a">
                    ...
                    <p>
                        <strong>
                            R&eacute;f&eacute;rences en mati&egrave;re de recrutement et d&rsquo;emploi
                        </strong>
                    </p>
            ...
            SENSIBILISATION ET FORMATION DES EMPLOY&Eacute;S
                ...
                <ul>
                    ...
                    <a
                        ...
                        title="R&eacute;f&eacute;rences en mati&egrave;re de recrutement et d&rsquo;emploi"
                    >
                        <strong>
                        R&eacute;f&eacute;rences en mati&egrave;re de recrutement et d&rsquo;emploi
                        </strong>
                ...
                <p>
                    ...
                    est le fruit d&rsquo;un travail de collaboration entre le d&eacute;partement d'&Eacute;tat des &Eacute;tats-Unis, 
                    Verit&eacute;, Made in a Free World et l&rsquo;Aspen Institute. Le contenu de RST a &eacute;t&eacute; fourni par 
                    Verit&eacute;, organisation de d&eacute;fense des droits des travailleurs disposant d&rsquo;une expertise en 
                    mati&egrave;re de conformit&eacute; de la cha&icirc;ne d'approvisionnement, avec un financement de l&rsquo;Office 
                    charg&eacute; de la surveillance et de la lutte contre la traite des personnes du d&eacute;partement d'&Eacute;tat 
                    des &Eacute;tats-Unis en vertu de l&rsquo;accord de coop&eacute;ration S-SJTIP-13-CA-1029. L&rsquo;&eacute;laboration 
                    de l&rsquo;outil RST a &eacute;t&eacute; inform&eacute;e par des experts issus de diff&eacute;rents organismes publics 
                    des &Eacute;tats-Unis, notamment les D&eacute;partements d'&Eacute;tat et du Travail des &Eacute;tats-Unis, ainsi que 
                    d&rsquo;autres parties prenantes de premier plan, notamment des survivants de la traite, des dirigeants 
                    d&rsquo;entreprises et d&rsquo;ONG et des responsables des acquisitions et des passations de march&eacute; au niveau 
                    f&eacute;d&eacute;ral.
                </p>
            </ExampleInAction>
                
                <p>
                    Les outils d'audit de qualit&eacute; vont au-del&agrave; de simples &laquo; listes de contr&ocirc;le &raquo;. De bons 
                    outils permettent d'enregistrer les informations non verbales obtenues par les auditeurs en observant les conditions 
                    sur le site et l&rsquo;atmosph&egrave;re dans le lieu de travail, l'expression corporelle des personnes interrog&eacute;es 
                    et d&rsquo;autres indices. Les auditeurs devraient examiner &agrave; l'avance les vuln&eacute;rabilit&eacute;s 
                    &eacute;ventuelles de la main-d'&#339;uvre de l'&eacute;tablissement et faire preuve de vigilance pour rep&eacute;rer des 
                    indices subtils indiquant que les travailleurs font l'objet de pressions ou de coercition. Les outils d'audit devraient 
                    permettre d'enregistrer des informations qui ne sont pas directement li&eacute;es aux questions se trouvant dans l'outil, 
                    mais qui selon l'auditeur sont importantes et pertinentes.
                </p>
                <p>
                    Les entreprises exigent de plus en plus de leurs sous-traitants et de leurs fournisseurs qu&rsquo;ils effectuent des 
                    auto-&eacute;valuations afin de souligner les risques potentiels de travail forc&eacute; et de traite des personnes
                    dans la cha&icirc;ne d&rsquo;approvisionnement. L&rsquo;
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    >
                     ...
                     de l&rsquo;Outil d&rsquo;approvisionnement responsable [disponible en anglais] est con&ccedil;u pour aider les 
                     fournisseurs et les sous-traitants &agrave; d&eacute;terminer si leurs activit&eacute;s sont conformes aux codes 
                     de conduite de la soci&eacute;t&eacute; ou du secteur et &agrave; souligner les risques potentiels de traite des 
                     personnes dans leurs processus de recrutement, de s&eacute;lection et d&rsquo;embauche des travailleurs, dans leur 
                     collaboration avec des courtiers de main d'&#339;uvre et dans leur supervision des travailleurs migrants. Cet outil 
                     peut servir de diff&eacute;rentes mani&egrave;res comme outil de s&eacute;lection de fournisseurs, pour &eacute;laborer 
                     des plans d&rsquo;action corrective ou pour mettre en place des indicateurs de performance cl&eacute;s afin de suivre 
                     les r&eacute;sultats en cours en mati&egrave;re de responsabilit&eacute; sociale.                    
                </p>
                <p>
                    Les{" "}
                    <a
                    ...
                    >
                        Crit&egrave;res d&rsquo;authentification institutionnelle de lutte contre la traite des personnes
                    </a>{" "}
                    [en anglais] de Verit&eacute; constituent un autre outil important qui peut servir &agrave; toute organisation ou 
                    partie tierce ind&eacute;pendante &agrave; authentifier l&rsquo;ampleur et l&rsquo;efficacit&eacute; des efforts de 
                    lutte contre la traite des personnes d&rsquo;une organisation. Cet outil fournit aux &eacute;valuateurs des 
                    crit&egrave;res d&rsquo;authentification de la conformit&eacute; d&rsquo;une soci&eacute;t&eacute; &agrave; ses efforts 
                    de lutte contre la traite des personnes, notamment ses engagements politiques, la responsabilit&eacute; de son conseil 
                    d&rsquo;administration et de ses cadres, sa structure organisationnelle, l&rsquo;&eacute;valuation et le contr&ocirc;le 
                    des risques et les attentes en mati&egrave;re de r&eacute;sultats. Il propose les pratiques exemplaires pour chaque 
                    crit&egrave;re ainsi que les &eacute;l&eacute;ments de preuve n&eacute;cessaires pour la v&eacute;rification. Il fournit 
                    &eacute;galement aux &eacute;valuateurs des orientations pour authentifier la conformit&eacute; au niveau du site &agrave; 
                    ces efforts, notamment en pr&eacute;cisant des crit&egrave;res minimaux.
                </p>
            </div>
        </StaticData>
    );
